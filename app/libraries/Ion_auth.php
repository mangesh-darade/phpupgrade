...
class Ion_auth
{
        ...
        if ($this->auth_model->forgotten_password($identity)) {   //changed
            ...
            if ($user) {
                ...
                if (!$this->config->item('use_ci_email', 'ion_auth')) {
                   ...
                   $message = $message . "Hello ".$user->first_name.", Your username is ".$user->username.".<br>" . lang('reset_password_link_alt') . "<br>" . site_url('auth/reset_password/' . $user->forgotten_password_code);
    ...
    public function getUserGroup($user_id = false)
    {
       ...
       return $this->auth_model->getGroup($group_id);
