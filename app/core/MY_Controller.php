...
class MY_Controller extends CI_Controller {
    ...
    function __construct()
    {
        ...
        if($this->loggedIn) {
            ...
            $this->Businessowner = $this->sma->in_group('businessowner') ? TRUE : NULL;
            $this->data['Businessowner'] = $this->Businessowner;
    ...
    function page_construct($page, $meta = array(), $data = array()) {
        ...
        $meta['Businessowner'] = isset($data['Businessowner']) ? $data['Businessowner'] : null;
