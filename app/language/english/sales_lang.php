...
$lang['challan_status']                      = "Challan Status";
...
$lang['type_of_sale']                       = "Type Of Sale";
$lang['processing']                         = "Processing";
$lang['cancelled']                          = "Cancelled";
$lang['sale_x_edited_older_than_3_months']  = "sale can not be edited older than 3 months";
$lang['email_sent_for_sale']                = "sale can not be edited older than 3 months";
$lang['email_sent_msg']                     = "Email has been sent successfully";
$lang['date_range']                         = "Start - End Date";



$lang['add_challan']                           = "Add Challan";
$lang['edit_challan']                          = "Edit Challan";
$lang['delete_challan']                        = "Delete Challan";
$lang['delete_challans']                       = "Delete Challans";
$lang['challan_added']                         = "Challan successfully added";
$lang['challan_updated']                       = "Challan successfully updated";
$lang['challan_deleted']                       = "Challan successfully deleted";
$lang['challans_deleted']                      = "Challans successfully deleted";

$lang['challan_x_action']                      = "This action can not be performed for challan with a return record";
$lang['challan_already_returned']              = "Challan already have return record";
$lang['challan_is_returned']                   = "Challan has return record";
$lang['challan_already_paid']                  = "Payment status is already paid for the challan";
$lang['payment_already_paid']                   = "Payment is already paid";
$lang['challan_x_edited_older_than_3_months']  = "challan can not be edited older than 3 months";
$lang['challan_x_edited_older_than_x_days']    = "Challan can't be edited as this challan is older than %d days.";
$lang['return_challan_added']                  = "Return challan successfully added";

$lang['no_challan_selected']                   = "No Challan selected. Please select at least one challan.";
$lang['you_will_loss_challan_data']            = "You will loss current challan data. Do you want to proceed?";
$lang['challan_status_x_competed']             = "Challan status is pending, you can add return challan for only completed Challans.";

/*******************************************************
Eshop Order
********************************************************/
$lang['add_eshop_order']                           = "Add EShop Order";
$lang['edit_eshop_order']                          = "Edit EShop Order";
$lang['delete_eshop_order']                        = "Delete EShop Order";
$lang['delete_eshop_orders']                       = "Delete EShop Orders";
$lang['eshop_order_added']                         = "EShop Order successfully added";
$lang['eshop_order_updated']                       = "EShop Order successfully updated";
$lang['eshop_order_deleted']                       = "EShop Order successfully deleted";
$lang['eshop_orders_deleted']                      = "EShop Orders successfully deleted";

$lang['eshop_order_x_action']                      = "This action can not be performed for Eshop Order with a return record";
$lang['eshop_order_already_returned']              = "EShop Order already have return record";
$lang['eshop_order_is_returned']                   = "EShop Order has return record";
$lang['eshop_order_already_paid']                  = "Payment status is already paid for the EShop Order";
$lang['eshop_order_x_edited_older_than_3_months']  = "EShop Order can not be edited older than 3 months";
$lang['eshop_order_x_edited_older_than_x_days']    = "EShop Order can't be edited as this EShop Order is older than %d days.";
$lang['return_eshop_order_added']                  = "Return EShop Order successfully added";

$lang['no_eshop_order_selected']                   = "No EShop Order selected. Please select at least one EShop Order.";
$lang['you_will_loss_eshop_order_data']            = "You will loss current EShop Order data. Do you want to proceed?";
$lang['eshop_order_status_x_competed']             = "EShop Order status is pending, you can add return EShop Order for only completed Challans.";

$lang['sale_x_return_older_than_x_days']  = "sale can not be return older than %d days";