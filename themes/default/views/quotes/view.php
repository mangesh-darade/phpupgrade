                ...
                <div class="well well-sm">
                    ...
                    <div class="col-xs-4 border-right">
                        ...
                        <div class="col-xs-10">
                            ...
                            <?php
                            echo $customer->address . "<br>" . (($customer->city != '' && strpos(strtolower($customer->address), strtolower($customer->city)) === false) ? $customer->city . " " : '') . $customer->postal_code . " " . $customer->state . "<br>" . $customer->country;
                            echo "<p>";
