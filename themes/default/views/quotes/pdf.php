    ...
    <div class="row">
        <div class="col-lg-12">
            <?php if ($logo) { ?>
                <div class="text-center" style="margin-bottom:20px;">
                    <img src="<?= base_url() . 'assets/mdata/'.$Customer_assets.'/uploads/logos/' . $biller->logo; ?>"
                         alt="<?= $biller->company ?>" style="max-height: 55px; max-width: 160px; width: auto; height: auto;">
                </div>
            <?php } ?>
            ...
            <div class="row padding10">
                ...
                <div class="col-xs-5">
                    <div class="bold">
                        <?=lang("date");?>: <?=$this->sma->invoiceDisplayDate($inv->date, $_invoice_show_time);?><br>
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover table-striped print-table order-table">
                    ...
                    <tr>
                        ...
                        <th style="width:30%;"><?= lang("Product Name"); ?> (<?= lang("code"); ?>)</th>
                        <th><?= lang("MRP"); ?></th>
...
$total_netcost += ($row->real_unit_price*$row->unit_quantity);
                        ...
                        //Dyanamic Tax Implementation 
                        echo $this->sma->taxAttrTBL_csi_dynamic($row, 'quote');
                        ?>
                        <?php
                        $r++;
                    endforeach;
                	...
                	<div class="col-xs-12"><?php
                        if ($Settings->invoice_view == 1) {
                            ...
                            //$resTaxTbl = $this->sma->quoteTaxInvvoiceTabel($tax_summary,$taxItems,$inv,$return_sale,$Settings,1);
            	     	    // echo  $resTaxTbl;
                             echo $this->sma->getTaxQuotationsReport($inv->id, $Settings);
                        } ?>
                        </div>
                </div>
            <div class="row">
