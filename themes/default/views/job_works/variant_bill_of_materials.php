...
<head>
    ...
    <!-- <link href="<?= $assets ?>job_works/css/style.css" rel="stylesheet" /> -->
    <link href="<?= $assets ?>job_works/css/Variant_bill_of_materials.css" rel="stylesheet" />
    <script type="text/javascript" src="<?= $assets ?>job_works/js/Variant_bill_of_material.js"></script>
    ...
    <style>
        ...
        .right_section.bom-raw-sidebar-visible {
    ...
    <style>
        ...
        /* BOM ingredients table: narrow plain delete (no red block; not full .btn width) */
        button.bom-line-delete-btn {
        ...
        button.bom-line-delete-btn:hover,
        button.bom-line-delete-btn:focus {
            color: #333 !important;
            background: transparent !important;
            outline: none;
        }
        #dynamicTable th.bom-col-delete,
        #dynamicTable td.bom-col-delete {
            width: 2.25rem;
            max-width: 2.75rem;
        ...
        #dynamicTable th.bom-col-delete .fa {
            font-size: 14px;
            color: #888;
        }
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12 p-0">
                                ...
                                <li class="btn set-bdr-none">
                                    <span class="font-weight">
                                        <img id="" class="mr-1 hand-o-left" style="margin-right: 7px; "
                                            src="<?= base_url() ?>/themes/default/assets/job_works/images/Back Arrow.svg" />
                                    </span>
                                    <span class="catName"
                                    ...
                                    <span class="font-weight-right">
                                        <img id="" class="mr-1" style="margin-right: 7px; "
                                            src="<?= base_url() ?>/themes/default/assets/job_works/images/Right Arrow.svg" />
                                    </span>
                        ...
                        <div class="bom_material_section_item" style="display: none;">
                            <div class="d-flex align-items-center set-bg-8 Displayset">
                                <div class="container-fluid">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2 col-sm-2 mb-2">
                                            <button id="backid" class="clickme ">Back</button>
                                        </div>
                                        ...
                                        <div class="col-md-3 col-sm-6 mb-3">
                                            ...
                                            <div class="mt-1">
                                                ...
                                                <span id="product_process_inline"></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3 col-sm-6 mb-3">
                                            ...
                                            <div class="input-group">
                                                <!-- <input type="text" id="created_at" name="requestDeliveryDate"
                                                    class="form-control" placeholder="Select a date"> -->
                                ...
                                <div class="row">
                                    ...
                                    <!-- <div class="col-md-3 col-sm-6 mb-3">
                                        <strong>Is Batch Only:</strong><br>
                                        <label class="switch">
                                    ...
                                    <!-- Min Qty (wrapped in container for control) - will be hidden -->
                                    <!-- <div id="minQtyContainer" class="col-md-3 col-sm-6 mb-3">
                                        <strong>Min. Qty:</strong><br>
                                        <input type="number" name="min_batch_qty" value="0" id="min_batch_qty"
                                            class="form-control text-end minqtyset min_batch_qty" placeholder="1" min="0" required>
                                    </div> -->

                                    <!-- UOM - will expand to col-md-4 when Min Qty is hidden -->
                                    <!-- <div class="col-md-3 col-sm-6 mb-3 uom-field">
                                        <strong>UOM:</strong><br>
                                        <select class="form-control units" id="uom_select">
                                    ...
                                    <!-- Sale Unit - will expand to col-md-5 when Min Qty is hidden -->
                                    <!-- <div class="col-md-3 col-sm-6 mb-3 sale-uom-field">
                                        <strong>Sale Unit & UOM:</strong><br>
                                        <div class="input-group d-flex align-items-center gap-2"
                                            style="display: flex;" min="0" required>
                                            <input type="text" id="sale_unit" class="form-control text-end Saleunitset sale_unit"
                                                placeholder="0" style="flex: 1;" />
                                            <select id="sale_unit_uom" class="form-select" style="flex: 1;">
                        ...
                        <div class="bom_material_section" style="display: none;">
                            <div class="d-flex justify-content-between align-items-center set-bg-8">
                                ...
                                <div class="col-md-5 p-2">
                                    <!-- Process (Standard Job Work) Dropdown -->
                                    <div class="mt-2" id="intermediateProductsContainer" style="display: none;">
                                        <strong>Process:</strong><br>
                                        <select class="form-control" id="intermediateProductsDropdown" style="width: 100%; margin-top: 5px;">
                                            <option value="">Select process</option>
                                        </select>
                                        <div id="processSelectError" class="text-danger" style="display: none; margin-top: 5px; font-size: 12px;"></div>
                                    </div>
                                </div>
                                <!-- Right: Add Button -->
                    ...
                    <div class="wd-set bg-setting right_section col-md-2">
                        <div class="search-container">
                            <input type="text" placeholder="Search..." name="query" class="search-box"
                                id="raw_material_search">
                            <button type="" class="search-button"><i class="fa fa-search"></i></button>
                        </div>
                        <h3 class="m-0_10 text-left orderNo">
                            <b><span id="raw_material_title">Raw Material</span></b>
                        </h3>
                        <div class="row padding-set">
                            <div class="wd-setting" style="">
...
<script>
    ...
    if (typeof site === 'undefined') {
        var site = { settings: { qty_decimals: <?= $this->Settings->qty_decimals; ?>, decimals: <?= $this->Settings->decimals; ?> } };
    } else {
        if (!site.settings) site.settings = {};
        site.settings.qty_decimals = <?= $this->Settings->qty_decimals; ?>;
        site.settings.decimals = <?= $this->Settings->decimals; ?>;
    }
