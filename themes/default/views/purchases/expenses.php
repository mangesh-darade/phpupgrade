...
?>
<style>
    #EXPData th:nth-child(7),
    #EXPData td:nth-child(7) {
...
<script>
    $(document).ready(function () {
        ...
        var oTable = $('#EXPData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('purchases/getExpenses'. $v); ?>',
            ...
            "aoColumns": [{
                "bSortable": false,
                "mRender": checkbox
            }, {"mRender": fld}, null, null, null, null, {"mRender": currencyFormat}, null, null, {
                "bSortable": false,
                "mRender": attachment
            }, {"bSortable": false}],
            ...
            {column_number: 5, filter_default_label: "[<?=ucfirst(lang('subcategory'));?>]", filter_type: "text", data: []},
                ...
                <div class="table-responsive">
                    <table id="EXPData" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <tr class="active">
                            ...
                            <th class="col-xs-1" style="text-align: right !important;"><?= lang("amount"); ?></th>
