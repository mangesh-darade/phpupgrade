    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                ?>
                <?= form_dropdown('category', $ct, set_value('category'), 'class="form-control tip" id="categoryexp"'); ?>
            </div>
            ...
            <div class="form-group">
                ...
                ?>
                <?= form_dropdown('subcategory', $sct, set_value('subcategory'), 'class="form-control tip" id="subcategoryexp"'); ?>
            </div>
...
<script type="text/javascript" charset="UTF-8">
    $(document).ready(function () {
        ...
        $('#categoryexp').on('change', function () {
