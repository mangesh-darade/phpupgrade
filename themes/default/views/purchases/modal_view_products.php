                   ...
                   if ($Owner || $Admin || ($GP['products-cost']=='1')) { 
                    ...
                    <?php if ($inv->grand_total != $inv->total) { ?>
                        <tr>
                            ...
                            <td><?php echo $this->sma->formatMoney($total)?></td>
                            <?php
                            if ($Settings->tax1 && $inv->product_tax > 0) {
					...
					$cc = $col+1;
                    if ($return_purchase) {
                        echo '<tr><td colspan="'.$cc.'" style="text-align:right; padding-right:20px;">' . lang("return_total") . ' (' . $default_currency->code . ')</td><td style="text-align:right; padding-right:10px;">' . $this->sma->formatMoney($rtotal) . '</td></tr>';
                    }
                    ?>
                    <tr>
                        <td colspan="<?= $cc; ?>"
...
//                        print_r($inv); exit;
                        $inv->product_tax = $tax;
                            $return_purchase->product_tax = $rtax;
