...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        <?php $attrib = array('data-toggle' => 'validator', 'role' => 'form', 'id' => 'purchase_id');
            ...
            <div id="payments">
                ...
                <div class="well well-sm well_1">
                    <div class="col-md-12">
                                ...
                                <div class="payment">
                                    <div class="form-group">
                                        ...
                                        <input name="amount-paid" type="text" id="amount_1"
                                               value="<?= $this->sma->formatDecimal(($inv->grand_total+$inv->rounding) - $inv->paid) ?>"
                                               class="pa form-control kb-pad amount"style="text-align: right !important;" required="required"/>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                        ...
                        <div class="pgcard_1" style="display:none;">
                            <div class="form-group"><?= lang("gift_card", "gift_card"); ?>
                                <input name="gift_card" type="text" id="gift_card" class="form-control cheque_no"/>
                            </div>
                        </div>
						 <div class="form-group g_transaction_id" style="display: none;">
...
<script type="text/javascript" charset="UTF-8">
   ...
   // $( '#purchase_id').submit(function( event ) {
    // $gcv = $('#gift_card').val();
    //if ($gcv != "" ) {
      // return true;
   // }else { alert("Please fill the gift card number to proceed for payment!"); return false; }
//});
