...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        // Enable only received quantity fields, disable all others
        setTimeout(function() {
            enableOnlyReceivedFields();
        }, 100);
        ...
        observer.observe(document.getElementById('poTable'), {
            childList: true,
            subtree: true
        });
        
        function enableOnlyReceivedFields() {
            // Enable received quantity input fields (editable)
            $('.received').prop('disabled', false)
                          .css('pointer-events', 'auto')
                          .css('background-color', '#fff');

            // Make other fields read-only for the user, but NOT disabled so they still post
            // $('input:not(.received):not([type="submit"]):not([type="button"])')
            //     .prop('readonly', true)
            //     .css('background-color', '#f5f5f5');
            // For selects/textareas, keep them visually locked but we'll re-enable before submit
...
<?php } ?>
        ...
        $('#edit_pruchase').click(function () {
            $(window).unbind('beforeunload');
            var $form = $('form.edit-inward-form');
            // Ensure all fields are enabled so quantities/products post correctly
            $form.find('input, select, textarea').prop('disabled', false).prop('readonly', false).css('pointer-events', '');
            $form.submit();
        });
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-eye"></i><?= lang('Inward PO'); ?></h2>
    </div>
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                <?php
                $attrib = array('data-toggle' => 'validator', 'role' => 'form', 'class' => 'edit-inward-form');
                echo form_open_multipart("purchases/inward_po/" . $inv->id, $attrib)
                ?>
                <div class="row">
                    <div class="col-lg-12">
                        <?php if ($Owner || $Admin || $GP['purchases-date']) { ?>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <?= lang("date", "podate"); ?>
                                    <?php echo form_input('date', (isset($_POST['date']) ? $_POST['date'] : $this->sma->hrld($purchase->date)), 'class="form-control input-tip datetime" id="podate" required="required" disabled="disabled"'); ?>
                                </div>
                            </div>
                        <?php } ?>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <?php echo form_input('reference_no', (isset($_POST['reference_no']) ? $_POST['reference_no'] : $purchase->reference_no), 'class="form-control input-tip" id="poref" required="required" disabled="disabled"'); ?>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                echo form_dropdown('warehouse', $wh, (isset($_POST['warehouse']) ? $_POST['warehouse'] : $purchase->warehouse_id), 'id="powarehouse" class="form-control input-tip select" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("warehouse") . '" required="required" style="width:100%;" disabled="disabled"');
                                ?>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="<?= $purchase->supplier ?>" disabled="disabled">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                echo form_dropdown('status_disabled', $post, 'received', 'id="postatus" class="form-control input-tip select" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("status") . '" required="required" style="width:100%;" disabled="disabled"');
                        ...
                        <div class="col-md-12">
                            <div class="control-group table-group">
                                ...
                                <div class="controls table-controls" style="pointer-events: none;">
                                    <table id="poTable"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <input type="checkbox" class="checkbox" id="extras" value="" disabled="disabled"/>
                            ...
                            <div class="row" id="extras-con" style="display: none;">
                                <?php if ($Settings->tax1) { ?>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            echo form_dropdown('order_tax', $tx, "", 'id="potax2" class="form-control input-tip select" style="width:100%;" disabled="disabled"');
                                            ?>
                                        </div>
                                    </div>
                                <?php } ?>
                                <?php if ($Settings->purchase_order_discount == '1') { ?>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <?php echo form_input('discount', '', 'class="form-control input-tip" id="podiscount" disabled="disabled"'); ?>
                                        </div>
                                    </div>
                                <?php } ?>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <?php echo form_input('shipping', '', 'class="form-control input-tip" id="poshipping" disabled="disabled"'); ?>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <?php echo form_input('payment_term', '', 'class="form-control tip" data-trigger="focus" data-placement="top" title="' . lang('payment_term_tip') . '" id="popayment_term" disabled="disabled"'); ?>
                                    </div>
                                </div>
                            </div>
                            <div class="clearfix"></div>
                            <div class="form-group">
                                <?= lang("note", "ponote"); ?>
                                <?php echo form_textarea('note', (isset($_POST['note']) ? $_POST['note'] : ""), 'class="form-control" id="ponote" style="margin-top: 10px; height: 100px;" disabled="disabled"'); ?>
                            </div>
                        </div>
                        <!-- GRN Section -->
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($grn_data as $grn): ?>
                                                    <tr>
                                                        ...
                                                        <td><?= $grn->date; ?></td>
                                                        <td><?= $grn->po_number; ?></td>
                                                        <td><?= !empty($grn->product_name) ? $grn->product_name : '-'; ?></td>
                                                        <td><?= !empty($grn->variant_name) ? $grn->variant_name : '-'; ?></td>
                                                        <td style="text-align:center;"><?= $this->sma->formatQuantity($grn->received_quantity); ?></td>
                                                    </tr>
                                                <?php 
                                                    $grn_count++;
                                                endforeach; 
