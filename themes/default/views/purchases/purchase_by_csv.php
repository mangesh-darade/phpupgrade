                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="well well-sm">
                            <a href="<?php echo $this->config->base_url(); ?>assets/mdata/<?php echo $Customer_assets; ?>/csv/sample_purchase_products.xlsx"
                            ...
                            <?php echo $this->lang->line("csv2"); ?> <span
                                class="text-info">(<?= lang("product_code") . ', ' . lang("net_unit_cost") . ', ' . lang("quantity") . ', ' . lang("product_variant") . ', ' . lang("Tax_Rate_Code") . ', ' . lang("discount") . ', ' . lang("expiry"); ?>
                                )Tax Rate Code<a  href="#" id="tax_rate" class="external"   data-toggle="modal" data-target="#taxrateModal">
                                   HELP</a></span> </span> <?php echo $this->lang->line("csv3"); ?><br>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group"style="width:990px">
                            <?= lang("note", "ponote"); ?>
                            <?php echo form_textarea('note', (isset($_POST['note']) ? $_POST['note'] : ""), 'class="form-control" id="ponote" style="margin-top:1px; height: 100px;"'); ?>
                        </div>
...
<div class="modal"  id="taxrateModal" tabindex="-1" role="dialog" aria-labelledby="prModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        <div class="modal-header">
           ...
           <h4 class="modal-title" id="myModalLabel"><?= lang('Tax_Rate_Code'); ?></h4>
        </div>
            ...
            <div class="table-responsive">
                <table id="CompTable" class="table table-bordered table-hover table-striped">
                    ...
                    <tr>
                        ...
                        <th style="width:30%;"><?= $this->lang->line("code"); ?></th>
                        <th style="width:15%;"><?= $this->lang->line("Tax_Rate"); ?></th>
