...
<div class="page-back">
    <div class="text-center"><?php if ($Settings->logo2) {
            echo '<img src="' . base_url('assets/mdata/'.$Customer_assets.'/uploads/logos/' . $Settings->logo2) . '" alt="' . $Settings->site_name . '" style="margin-bottom:10px;" />';
        } ?></div>
    <div id="login">
        ...
        <div class=" container">
            ...
            <div class="login-form-div">
                <div class="login-content">
                    ...
                    <div class="form-action clearfix" style="margin :0 4%;">
