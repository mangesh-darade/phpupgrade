            ...
            <div class="container">
                ...
                <div class="header-nav">
                    ...
                    <ul class="nav navbar-nav pull-right">
                        ...
                        <?php } else { ?>
                        <li class="dropdown hidden-sm">
                            <a href="<?= site_url('pos/short_setting'); ?>" id=""
                    ...
                    <i class="fa fa-credit-card"></i>
                        ...
                        <li class="dropdown hidden-xs">
                            <a class="btn bblue pos-tip" title="<?= lang('clear_ls') ?>" data-placement="bottom"
                                id="clearLS" href="#">
...
//                            $this->sma->pos_error_log($logger);
                                    ...
                                    <div id="left-bottom">
                                        ...
                                        <div id="botbuttons" class="col-xs-12 text-center">
                                            <input type="hidden" name="biller" id="biller"
											 ...
											 <?php if ($subdomain !="magicwears" || $GP['pos-apply_coupon']) { ?>
											...
											<?php } ?>
											<?php if ($subdomain !="magicwears" || $GP['pos-discription']) { ?>
                                            <div class="row" style="margin-bottom:6px;">
                                                ...
                                                <div class="col-xs-4 padding0">
                                                    <div class="btn-group-vertical btn-block">
                                                        ...
                                                        <button type="button" id="suspend"
                                                            ...
                                                            KOT </button>
                                                        <?php } elseif ($Settings->theme == 'theme_four' || $Settings->theme == 'theme_five') { ?>
                                                        ...
                                                        <button type="button" id="suspend_sale1"
                                                         ...
                                                         <button type="button"
                                                                ...
                                                                style="width: 48%;float: left; margin-left:-2px;">
                                                                <?= lang('cancel'); ?>
                                                            </button>
                                                            <button type="button"
                                                                class="btn btn-warning btn-block btn-flat"
                                                                id="shifttable" style="width: 51%;float:right; ">
                                                                <?= lang('Shift'); ?>
                                                            </button>
                                                    </div>
                                                ...
                                                <div class="col-xs-4 padding0">
                                                    <div class="btn-group-vertical btn-block">
                                                        ...
                                                        <button type="button" class="btn btn-primary btn-block"
                                                            id="print_bill" style="margin-left: 2px;">
                                                            <?= lang('bill'); ?>
                                                        </button>
                                                        <?php } else { ?>
                                                        <button type="button"
    ...
    ?>
                                    ...
                                    <div class="no-print">
                                        ...
                                        <div class="col-md-3 pr-0 ">
                                            <select name="seasons" id="seasons" class="col-md-12">
 											...
 											<?php 
                                            if ($Owner || $Admin || $GP['pos-category_search']) { ?>
                                ...
                                <div id="proContainer">
                                    <div id="ajaxproducts">
                                        <div id="item-list" style="position: sticky;">
                                            <?php echo $products; ?>
                                        </div>
                                        <div class="btn-group btn-group-justified pos-grid-nav">
                                            <div class="btn-group prev">
                    ...
                    <form class="form-horizontal" role="form">
                        ...
                        <tr>
                                ...
                                <td>
                                    ...
                                    <input type="text" class="form-control kb-pad inputvalcheck selling " id="pmrp">
                                    <!-- <?= ($Owner || $Admin || $GP['cart-price_edit']) ? '' : 'readonly="readonly" onchange="return false"'; ?>> -->
                                </td>
                                ...
                                <td>
                                    ...
                                    <input type="text" class="form-control kb-pad inputvalcheck selling" id="selling"
                                        <?= ($Owner || $Admin || $GP['cart-price_edit']) ? '' : 'readonly="readonly" onchange="return false"'; ?>>
                                </td>
...
?>
                    ...
                    if (data !== null) {
                        <?php if ($Settings->overselling == '0') { ?>
                            if (data.row.quantity == null || parseFloat(data.row.quantity) <= 0) {
                                bootbox.alert('<?= lang('no_match_found') ?>');
                                $('#modal-loading').hide();
                                return false;
                            }
...
?>
    ...
    $(document).ready(function() {
        // document.getElementById('ajaxproducts').style.height="80%";
        // document.getElementById('item-list').style.height="100%";
        document.getElementById('ajaxproducts').style.height = "58%";
        document.getElementById('item-list').style.height = "100%";
    });
    // Customer Search
    ...
    $(document).ready(function() {
        $('#send-datas').click(function() {
            ...
            $('input.returntotal').each(function() {
                return_subtotal.push($(this).val().replace(/,/g, ''));
            });
            ...
            $('input.item_price').each(function() {
                item_price.push($(this).val().replace(/,/g, ''));
            });
            ...
            $('#mrdiscount').val(mrpdiscount);
            $('#mrp').val(mrp); 
            $('#unitprices').val(unitprices);
            $('#option_ids').val(optionIds);
...
function toggleCategoryView(categoryId, hasSubcategories) {
    ...
    if (hasSubcategories) {
        ...
        iconElement.onclick = function() {
            resetProductList(); // Reset the product list
    ...
    if (hasSubcategories) {
        Array.from(categoryContainer.children).forEach(child => {
            child.style.display = child.contains(clickedButton) ? 'block' : 'none';
        });
        subcatContainer.style.display = 'block';
    } else {
        Array.from(categoryContainer.children).forEach(child => {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.success) {
                        ...
                        var biller_name  =  response.primer_biller ? response.primer_biller : response.billers[0].id;
...
<!-- Multipler biller against locations End  -->
