...
<head>
    ...
    if (parent.frames.length !== 0) {
        top.location = '<?= site_url('pos_elite') ?>';
    }
    ...
    <?php } ?>
    <link rel="stylesheet" href="<?= $assets ?>pos/css/pos_elite.css" type="text/css" />
        ...
        <header id="header" class="navbar">
            <div class="container">
                ...
                <div class="header-nav">
                    <ul class="nav navbar-nav pull-right">
                        <li class="dropdown">
                            <a class="btn no-effect account dropdown-toggle" data-toggle="dropdown" href="#">
                                ...
                                <div class="user">
                                    <span><?= lang('welcome') ?>!
                                        <?= $this->session->userdata('username'); ?></span><br>
                    ...
                    <ul class="nav navbar-nav pull-right hide-header-elements">
                        <li class="dropdown hidden-xs">
                            <a class="btn bblue pos-tip" style="border-radius: 20px !important;"
                                title="<?= lang('products below alert quantity') ?>" data-placement="bottom" id=""
                                href="<?= site_url('products/index/0/alert_qty') ?>">
                                <i class="fa fa-bell"></i><sup style="font-size: 24px !important;"><?php echo $alertProd_Count['count']; ?></sup>
                            </a>
                        </li>
                        <li class="dropdown">
                            <a class="btn blightOrange pos-tip" id="opened_bills" title="<?= lang('suspended_sales') ?>"
                                data-placement="bottom" data-html="true" href="<?= site_url('pos_elite/opened_bills') ?>"
                                data-toggle="ajax">
                                <img src="<?= $assets ?>images/icon-spe.png" alt="suspended_sales"><span
                        ...
                        <li class="dropdown">
                            <a class="btn bdarkGreen pos-tip" id="pos_details" title="<?= lang('recent_pos_list') ?>"
                                data-placement="bottom" data-html="true" href="<?= site_url('pos_elite/recent_pos_list'); ?>"
                        ...
                        <li class="dropdown hidden-sm">
                            <a class="btn blightOrange pos-tip" id="pos_setting" title="<?= lang('settings') ?>"
                                data-placement="bottom" href="<?= site_url('pos_elite/settings') ?>">
                                <i class="fa fa-cogs"></i>
                            </a>
                        </li>
                        <?php } else { ?>
                        <li class="dropdown hidden-sm">
                            <a href="<?= site_url('pos_elite/short_setting'); ?>" id=""
                                class=" btn blightOrange pos-tip external" data-placement="bottom"
                                title="<?= lang('settings') ?>" data-toggle="modal" data-target="#myModal"
                                tabindex="-1">
                                <i class="fa fa-cogs"></i>
                            </a>
                        </li>
                        <?php
                            ...
                            ?>
                        <li class="dropdown">
                            <a class="btn bblue pos-tip" id ="pos_view" title="<?= lang('view_bill_screen') ?>" data-placement="bottom" href="<?= site_url('pos_elite/view_bill') ?>" target="_blank">
                        ...
                        <li class="dropdown">
                            <a class="btn bdarkGreen pos-tip" id="register_details"
                                ...
                                href="<?= site_url('pos_elite/register_details') ?>" data-toggle="modal"
                                data-target="#myModal">
                        ...
                        <li class="dropdown">
                            <a class="btn borange pos-tip" id="close_register" title="<?= lang('close_register') ?>"
                                data-placement="bottom" data-html="true" href="<?= site_url('pos_elite/close_register') ?>"
                                data-toggle="modal" data-target="#myModal">
                        ...
                        <li class="dropdown">
                            <a class="btn blightOrange pos-tip" id="view_purchases" title="<?= lang('purchases') ?>"
                                data-placement="bottom" href="<?= site_url('purchases') ?>">
                                <i class="fa fa-shopping-cart"></i>
                            </a>
                        </li>
                        <?php if ($Owner) { ?>
                        <li class="dropdown">
                            <a class="btn blightOrange pos-tip" id="today_profit" title="<?= lang('today_profit') ?>"
                        ...
                        <li class="dropdown">
                            <a class="btn bdarkGreen pos-tip" id="today_sale" title="<?= lang('today_sale') ?>"
                                data-placement="bottom" data-html="true" href="<?= site_url('pos_elite/today_sale') ?>"
                                data-toggle="modal" data-target="#myModal">
                        ...
                        <li class="dropdown hidden-xs book">
                            <a class="btn borange pos-tip" title="<?= lang('list_open_registers') ?>"
                                data-placement="bottom" href="<?= site_url('pos_elite/registers') ?>">
                    ...
                    <ul class="nav navbar-nav pull-right hide-header-elements">
                        <li class="dropdown cutlery">
                            <a class="btn bdarkGreen pos-tip" title="Kitchen Printer" data-placement="bottom"
                                rel="external" onclick="window.open(this.href, '_new');
                                            return false;" href="<?= site_url('screens/display/1') ?>">
                                <i class="fa fa-cutlery" aria-hidden="true"></i>
                            </a>
                        </li>
                        <li class="dropdown">
                            <a class="btn borange pos-tip" title="Bar Printer" data-placement="bottom" target="_blank"
                                href="<?= site_url('screens/display/2') ?>">
                    ...
                    <ul class="nav navbar-nav pull-right hide-header-elements">
                        <li class="dropdown">
                            <a class="btn no-effect themeicon dropdown-toggle" data-placement="bottom"
                                title="<?= lang('Theme Setting') ?>" data-toggle="dropdown" href="#"><i
                        ...
                        <li class="dropdown">
                            <a class="btn no-effect themeicon1 dropdown-toggle" data-placement="bottom"
                                title="<?= lang('New Offers') ?>" data-toggle="dropdown" href="#"><i
                    ...
                    <ul class="nav navbar-nav pull-right hide-header-elements display_time">
                        <li class="dropdown">
                    ...
                    <?php if ($Settings->pos_type == 'restaurant') { ?>
                    <ul class="nav navbar-nav hide-header-elements"
                        style="padding: 7px; background: coral; font-size: larger; font-weight: bold;">
...
//                            $this->sma->pos_error_log($logger);
                    ...
                    <div id="pos">
                        <?php
                            ...
                            echo form_open("pos_elite", $attrib);
                            ?>
                        <div id="leftdiv">
                            <div id="printhead">
                                                ...
                                                <div class="col-xs-4 padding0">
                                                    <div class="btn-group-vertical btn-block">
                                                        ...
                                                        <button type="button" id="suspend"
                                                            ...
                                                            onclick="window.location.href = '<?= base_url('pos_elite/kot') ?>'">
                                                            KOT </button>
                                                        <?php } else { ?>
                                                        ...
                                                        <button type="button" class="btn btn-danger btn-block btn-flat"
                                                            id="reset" style="width: 50%;float: left;">
                                                            <?= lang('cancel'); ?>
                                                        </button>
                                                        <button type="button" class="btn btn-warning btn-block btn-flat"
                                                            id="shifttable" style="width: 50%;float: left; ">
                                                            <?= lang('Shift'); ?>
                                                        </button>
                                                    </div>
                                ...
                                <div id="left-top">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-5 ">
                                                        <div class="input-group">
                                                            ...
                                                            <span id="lite_customer_name_display" style="display:none; background:#e8f0fe; color:#1565c0; font-size:27px; font-weight:700; padding:6px 8px; border:1px solid #ccd; border-left:none; white-space:nowrap; max-width:120px; overflow:hidden; text-overflow:ellipsis;  vertical-align:middle;"></span>
                                                            <div id="sales_icon"
                                                                class="input-group-addon first_menu no-print">
                                                                <span disabled="true" style="padding:8px;"
                                                    ...
                                                    <div class="col-sm-7">
                                                        <div class="input-group">
                                                            ...
                                                            <div class="input-group-addon padding28 roundbtn"
                                                                title="ADD CUSTOMER">
                                                                <a href="customers/add_quick" id="add-customer"
                                            ...
                                            <div class="col-sm-3"
                                                style='width:25%!important; <?php if ($pos_settingss->display_seller == 0) { ?>display:none; <?php } ?> '>
                                                <div class="row ">
                                                    <div class="col-sm-12 ">
    ...
    ?>
                                                    ...
                                                    <div id="sales_icon" class="input-group-addon third_menu no-print">
                                                        <a href="<?= site_url('customers/add_quick'); ?>"
                                            ...
                                            <div class="col-sm-3" id="sales_personId"
                                                <?php if ($pos_settingss->display_seller == 0) { ?>style="display:none;"
                                                <?php } ?>>
                                                <div class="row ">
                                                    <div class="col-sm-12 ">
                                                        <div class="select-group">
                                    ...
                                    <div class="no-print">
                                        ...
                                        <div class="form-group" id="ui">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <div class="input-group-addon padding28 borderblue"  style="display:none;" title="Rfid">
...
//for ($i = 1; $i <= 40; $i++) {
                                                    foreach ($categories as $category) {
                                                        if (file_exists('assets/mdata/'.$Customer_assets.'/uploads/thumbs/' . $category->image)) {
                                                            if ($category->image != "") {
                                                                $imgsrc = 'assets/mdata/'.$Customer_assets.'/uploads/thumbs/' . $category->image;
                                                            } else {
                                                                $imgsrc = 'assets/mdata/'.$Customer_assets.'/uploads/thumbs/no_image.png';
                                                            }
                                                        } else {
                                                            $imgsrc = 'assets/mdata/'.$Customer_assets.'/uploads/thumbs/no_image.png';
                                                        }
                                        ...
                                        <div class="cat-div">
                                            ...
                                            <div class="owl-carousel owl-theme">
                                                <?php
                                                        ...
                                                        . "<img src=\"assets/mdata/$Customer_assets/uploads/thumbs/no_image.png\" style='width:33px;height:33px;' class='img-rounded img-thumbnail' />"
                                                        . "<span> Favourite </span></button></div>";
//for ($i = 1; $i <= 40; $i++) {
                                                        foreach ($categories as $category) {
                                                            if (file_exists('assets/mdata/'.$Customer_assets.'/uploads/thumbs/' . $category->image)) {
...
//}
    ...
    <?php
        ...
        if ($Settings->theme == 'default') {
            ...
            $theme_model = 'checkout_model_' . $Settings->theme . '.php';
            if (file_exists(dirname(__FILE__) . DIRECTORY_SEPARATOR . $theme_model)) {
                include_once($theme_model);
            } else {
                include_once('checkout_model.php');
            }
        }
                    ...
                    <div class="radio-btn-section">
                        <ul class="nav nav-tabs">
                            ...
                            <li class="<?= ($key == 0 ? 'active' : '') ?>"><a data-toggle="tab"
                                    href="#<?= ($grp_table['table_group'] ? str_replace(" ", "", $grp_table['table_group']) : 'default' ) ?>"><?= ($grp_table['table_group'] ? $grp_table['table_group'] : 'Default' ) ?></a>
                            </li>
                            <?php } ?>
                        ...
                        <div class="tab-content">
                            ...
                            <div id="<?= ($items_tableG['table_group'] ? str_replace(" ", "", $items_tableG['table_group']) : 'default' ) ?>"
                                class="tab-pane fade <?= ($key == 0 ? 'in active' : '') ?>">
                                <strong
                                    style="display: block;clear: both; color: #FF0000; padding:10px"><?= ($items_tableG['table_group'] ? $items_tableG['table_group'] : 'Default' ) ?></strong>
                                <div class="row">
                                    <?php
            ...
            initSelection: function(element, callback) {
                $.ajax({
                    ...
                    success: function(data) {
                        $("#customer_deposit_link_default, #customer_deposit_link").attr("href",
...
?>
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    if (result.total_amount && result.paid) {
                        ...
                        $('#showdue').html('Due Amount: Rs. ' + due1 + '.00');
                    }
        ...
        $("#add_item").autocomplete({
            ...
            response: function(event, ui) {
                if (ui.content.length == 0 || (ui.content.length == 1 && ui.content[0].id == 0)) {
...
?>
        ...
        $(document).on('click', '.product', function(e) {
            ...
            $.ajax({
                type: "get",
                url: "<?= site_url('pos_elite/getProductDataByCode') ?>",
                data: {
                    code: code,
                    warehouse_id: wh,
                    customer_id: cu,
...
?>
        ...
        $(document).on('click', '.favouritebtn', function() {
            ...
            $.ajax({
                type: "get",
                url: "<?= site_url('pos_elite/featuerdProducts'); ?>",
                data: {
                    per_page: 'n'
                },
                dataType: "json",
        ...
        $(document).on('click', '.category', function() {
            ...
            $.ajax({
                type: "get",
                url: "<?= site_url('pos_elite/ajaxcategorydata'); ?>",
                data: {
                    category_id: cat_id
                },
                dataType: "json",
        ...
        $(document).on('click', '.brand', function() {
            ...
            if (brand_id != $(this).val()) {
                ...
                $.ajax({
                    type: "get",
                    url: "<?= site_url('pos_elite/ajaxbranddata'); ?>",
                    data: {
                        brand_id: brand_id
                    },
                    dataType: "json",
        ...
        $(document).on('click', '.subcategory', function() {
            ...
            if (sub_cat_id != $(this).val()) {
                ...
                $.ajax({
                    type: "get",
                    url: "<?= site_url('pos_elite/ajaxproducts'); ?>",
                    data: {
                        category_id: cat_id,
            ...
            $('#next').click(function() {
                ...
                if (tcp >= pro_limit && p_page < tcp) {
                    ...
                    if ($.isNumeric(cat_id) && cat_id != 0) {
                        ...
                        sendurl = "<?= site_url('pos_elite/ajaxproducts') ?>";
                    } else {
                        senddata = {
                            per_page: p_page
                        };
                        sendurl =
                            "<?= ((isset($featuerd_products) && $featuerd_products == 1) ? site_url('pos_elite/featuerdProducts') : site_url('pos_elite/ajaxproducts')); ?>";
                    }
...
?>
    ...
    <script type="text/javascript" src="<?= $assets ?>pos/js/pos.ajax_elite.js"></script>
...
?>
    ...
    function setCustomerAwardPoint(ba, sel) {
        ...
        $.ajax({
            type: "get",
            url: "<?= site_url('pos_elite/searchAwardPointByCustomer') ?>",
            data: {
                customer_id: cu,
                bill_amt: ba
            },
    ...
    function sendSMS() {
        ...
        $.ajax({
            ...
            datatype: 'json',
            method: "GET",
            url: "<?php echo base_url(); ?>pos_elite/send_otp",
            data: {
                MobileNo: MobileNo
            },
    ...
    function setCustomerGiftcard(bal, sel) {
        ...
        $.ajax({
            type: "get",
            url: "<?= site_url('pos_elite/searchGiftcardByCustomer') ?>",
            data: {
                customer_id: cus,
                bill_amt: bal
            },
    ...
    function setCustomerDeposit(ba, sel) {
        ...
        $.ajax({
            type: "get",
            url: "<?= site_url('pos_elite/searchDepositByCustomer') ?>",
            data: {
                customer_id: cu,
                bill_amt: ba
            },
            ...
            success: function(data) {
                ...
                if (data.balanceamt > 0) {
                    //$('#amount_1').val(ba).focus();
                    $('#depositdetails_1').html('<small>Value: ' + data.value + ' - Balance: ' + data
                        .balanceamt + '</small>');
                    if (ba > parseFloat(data.balanceamt)) {
                        ...
                        if (sel == 'deposit') {
                            bootbox.alert(
                                'Invoice amount is greater that available Deposit balance please select other payment mode'
                                );
                        }

                    }
                } else {
                    $('#depositdetails_1').html(
                        '<small class="red">Deposit not found for this customer</small>');
                }
            }
        });
    }
    ...
    function addItemTest(itemId) {
        ...
        $.ajax({
            ...
            url: "<?= site_url('pos_elite/getProductByID') ?>",
            data: {
                id: itemId
            },
            dataType: "json",
    ...
    /*
     ...
     $.ajax({
     type: "POST",
     url: '<?= base_url('pos_elite/set_saleorder'); ?>',
     data:'data='+data,
     beforeSend: function(){ },
...
?>
    ...
    $(document).ready(function() {
        ...
        $('#search_customer').keydown(function(e) {
    ...
    var defuatl_customer =
        '<?= ($_SESSION['quick_customerid'] ) ? $_SESSION['quick_customerid'] : $pos_settings->default_customer ?>';
        ...
        source: function(request, response) {
            ...
            if (request.term.length > 1) {
                ...
                $.ajax({
                    ...
                    url: '<?= site_url('pos_elite/getCustomerAuto'); ?>',
                    method: 'get',
                    async: false,
                    beforeSend: function() {
    ...
    $('#customer_name').autocomplete({
        ...
        source: function(request, response) {
            $.ajax({
                ...
                url: '<?= site_url('pos_elite/getCustomerName'); ?>',
                method: 'get',
                async: false,
                beforeSend: function() {
                    $('#loaderimg').show();
    ...
    function getCustomer(fieldkey, mobile_no) {
        ...
        $.ajax({
            ...
            dataType: 'json',
            data: pass_data,
            url: '<?= site_url('pos_elite/get_dependancy'); ?>',
            async: false,
            success: function(data) {
                if (data != null) {
                    ...
                    //}else{
                    $('#customer_name').val(data.name + '(' + data.phone + ')').trigger('change');
                    //}
                    $('#poscustomer').val(data.id).trigger('change');
                    $('#custname').val(data.id).trigger('change');
                    localStorage.setItem('poscustomer', data.id);
                    //                             console.log(localStorage);

                    $("#customer_deposit_link, #customer_deposit_link_default").attr("href", "<?= base_url('customers/add_deposit/') ?>" +
                        data.id);
                    ...
                    $('#add-customer').hide();
                    $('#error_message').html('');
                    $('#lite_customer_name_display').html('<i class="fa fa-user" style="margin-right:4px;"></i>' + data.name).show();
                } else {
                    $('#MobileNumber').val('');
                    $('#customer_name').val('').trigger('change');
                    $('#poscustomer').val('').trigger('change');
                    $('#lite_customer_name_display').hide().html('');
    ...
    function searchCustomer() {
        var mobile_no = $('#search_customer').val().trim();
        if (mobile_no == '') {
        ...
        if (mobile == true) {
            ...
            if (name == true && mobile == true) {
                ...
                $.ajax({
                    ...
                    dataType: 'json',
                    method: 'get',
                    url: '<?= site_url('pos_elite/addcustomer') ?>',
                    data: {
                        'mobile_no': getmobile,
                        'name': getname
                    },
                    ...
                    success: function(result) {
                        if (result.msg == 'Success') {
                            ...
                            $('#add-customer').hide();
                            $('#error_message').html('');
                            $("#customer_deposit_link, #customer_deposit_link_default").attr("href", "<?= base_url('customers/add_deposit/') ?>" + result.id);
                        } else {
                            console.log(result);
                        }
                        //                           
...
if ($_SESSION['Print_Deposite_Receipt']['status'] == '1') {
    ...
    function callTable(passid) {
        window.location.href = '<?= base_url('pos_elite/index') ?>/' + passid;
    }
    </script>
            ...
            callback: function(result) {
                if (result) {
                    $.ajax({
                        ...
                        url: '<?= base_url("pos_elite/table_seats") ?>',
                        async: false,
                        success: function(response) {
                            if (response.status) {
    ...
    function bill_print(table_id) {
        ...
        if (table_id == localStorage.getItem('table_id')) {
            ...
            $.ajax({
                ...
                dataType: 'html',
                method: 'get',
                url: '<?= base_url("pos_elite/billPrint") ?>/' + table_id,
                async: false,
                success: function(result) {
                    openWin(result);
                },
        ...
        $.ajax({
            ...
            dataType: 'json',
            method: 'get',
            url: "<?= base_url('pos_elite/tableBillPrint') ?>/" + table_id,
            data: {
                'billPrint': '1'
            },
            async: false,
    ...
    function update_token() {
        $.ajax({
            ...
            dataType: 'json',
            method: 'get',
            url: '<?= base_url("pos_elite/updateToken") ?>?TokenNo=' + token_no,
            async: false,
            success: function(result) {
                console.log(result);
            },
...
#header.navbar .header-nav .nav > li > a.btn {
...
#header.navbar .header-nav .nav > li > a.btn i {
    font-size: 18px;
}
#header.navbar .header-nav .nav > li > a.btn.bblue { background: #4db7dc !important; }
#header.navbar .header-nav .nav > li > a.btn.bdarkGreen { background: #27ae60 !important; }
#header.navbar .header-nav .nav > li > a.btn.blightOrange { background: #f39c12 !important; }
#header.navbar .header-nav .nav > li > a.btn.borange { background: #e67e22 !important; }

#header.navbar .account img {
    margin-top: 0;
}
#header.navbar .account .user {
    color: #333 !important;
}
#header.navbar .account .user span {
    color: #4db7dc !important;
    font-weight: bold;
}

nav.menu-opener, .btn-cat-con, #cp, #num, 
#printhead, #customer_button, #addManually, .sellGiftCard, .Offline,
#suspend, #suspend_sale1, #shifttable, #print_order, #print_bill, #DescriptionBtn, #discription_input_block 
{
    display: none !important;
}
...
@media screen and (max-width: 1024px) {
    ...
    #left-bottom .btn-success {
    height: 152px !important;
    border-radius: 5px !important;
    font-size: 56px;
    background: #08699a !important;
    }
    input#coupon_code {
    height: 78px;
    font-size: 40px;
    ...
    .elite-search-input .input-group-addon {
    font-size:30px;
    }
    #payment{
    flex: 2!important;
    ...
    .col-md-5.col-sm-5.text-center.card-div {
...
.elite-tools button:hover {
    background: #f1f1f1;
}

.elite-search-input .input-group,
.elite-search-input .form-control {
    width: 100% !important;
...
#paymentModal .modal-footer .btn-group {
    display: flex !important;
    width: 100%;
    gap: 12px;
}
#paymentModal .cmdnotprint {
    background: linear-gradient(135deg, #4db7dc 0%, #2980b9 100%) !important;
}
#paymentModal .cmdprint {
    background: linear-gradient(135deg, #27ae60 0%, #2ecc71 100%) !important;
}
#paymentModal .final-submit-btn:hover {
    transform: translateY(-2px);
    box-shadow: 0 6px 15px rgba(0,0,0,0.2) !important;
}

/* Hide sections in Payment Modal */
#paymentModal .btn-group-vertical,          /* Quick Cash buttons */
#paymentModal .class-title,                 /* Quick Cash title */
#paymentModal .addButton,                    /* Add More */
#paymentModal .font16,                       /* Totals Table */
#paymentModal .splitpay,                     /* Split Pay */
#paymentModal button[onclick="split_order();"], /* Split Check */
#paymentModal .cmdprint1                      /* Other button */ {
    display: none !important;
}
...
.elite-bot-btns button {
    flex-grow: 1;
    font-weight: bold;
    border-radius: 4px !important;
    padding: 12px !important;
}
#reset { background: #d9534f !important; border-color: #d43f3a !important; flex: 1; }
#payment { background: #5cb85c !important; border-color: #4cae4c !important; flex: 3; }
...
.elite-coupon-row input[type="text"] {
    flex: 3;
}
.elite-coupon-row input[type="button"] {
    flex: 1;
    border-radius: 4px !important;
    background: #5bc0de !important;
...
<script>
$(document).ready(function() {
    // 1. Move Customer Search
    var $eliteCustRow = $('<div class="elite-search-bar" style="margin-bottom: 8px;"></div>');
    var $eliteCustInput = $('<div class="elite-search-input "></div>');
    var $eliteTools = $('<div class="elite-tools"></div>');
    
    // Grab the existing input group containing #search_customer
    var $custGroup = $('#search_customer').closest('.input-group');
    if ($custGroup.length) {
        $custGroup.find('#sales_icon i').addClass('fa-search').removeClass('fa-pencil'); // Fix icon if needed
        $eliteCustInput.append($custGroup);
    }
    
    // Tools buttons
    var $saveBtn = $('<button type="button" onclick="$(\'#AddNewCustomer\').click()"><i class="fa fa-floppy-o"></i></button>');
    var $depositBtn = $('<button type="button" onclick="if($(\'#poscustomer\').val() > 0) { $(\'#customer_deposit_link\').click(); } else { bootbox.alert(\'Please select customer\'); }"><i class="fa fa-money"></i></button>');
    var $addBtn = $('<button type="button" onclick="$(\'#add-customer\').click()"><i class="fa fa-plus"></i></button>');
    $eliteTools.append($saveBtn).append($depositBtn).append($addBtn);
    
    $eliteCustRow.append($eliteCustInput).append($eliteTools);

    // 2. Move Customer Name
    var $eliteCustNameRow = $('<div class="elite-search-bar" style="margin-bottom: 15px; display: none;"></div>');
    var $eliteCustNameInput = $('<div class="elite-search-input"></div>');
    var $nameGroup = $('#customer_name').closest('.input-group');
    if ($nameGroup.length) {
        $eliteCustNameInput.append($nameGroup);
    }
    $eliteCustNameRow.append($eliteCustNameInput);
    
    // 3. Move Product Search
    var $eliteProdRow = $('<div class="elite-search-bar" style="margin-bottom: 8px;"></div>');
    var $eliteProdInput = $('<div class="elite-search-input"></div>');
    
    var $prodGroup = $('#add_item').closest('.row').length ? $('#add_item').closest('.row') : $('#add_item').parent();
    // If it's just the input, wrap it in a mock input-group with a search icon
    if (!$('#add_item').parent().hasClass('input-group')) {
        var $ig = $('<div class="input-group"></div>');
        var $ad = $('<div class="input-group-addon"><i class="fa fa-search"></i></div>');
        $('#add_item').wrap($ig).parent().append($ad);
        $prodGroup = $('#add_item').parent();
    }
    $eliteProdInput.append($prodGroup);
    $eliteProdRow.append($eliteProdInput);
    
    // Insert at the top of left-middle (inside #print area)
    $('#product-list').before($eliteProdRow);
    $('#product-list').before($eliteCustRow);
    $('#product-list').before($eliteCustNameRow);
    
    // 3. Fix bottom layout
    var $botBtns = $('#botbuttons');
    $botBtns.find('.row').hide(); // hide default rows
    
    // Coupon row
    var $couponRow = $('<div class="elite-coupon-row"></div>');
    $couponRow.append($('#coupon_code').detach());
    $couponRow.append($('#apply_coupon').detach());
    $botBtns.append($couponRow);
    
    // Checkout row
    var $checkoutRow = $('<div class="elite-bot-btns"></div>');
    $checkoutRow.append($('#reset').detach());
    $checkoutRow.append($('#payment').detach());
    $botBtns.append($checkoutRow);
    
    // Clean up empty containers
    $('#left-top').hide();

    // 4. Add Mobile Header Action Buttons
    // 4. Add Mobile Header Action Buttons
    if ($('.mob-header-actions').length === 0) {
        var $mobHeaderActions = $('<div class="mob-header-actions"></div>');
        
        // Dashboard button (Keep separate as requested)
        var $btnDash = $('a[href*="site_url(\'welcome\')"], a i.fa-dashboard').parent().first().clone(true).removeAttr('id block').removeClass('pos-tip');
        $btnDash.append('<span class="btn-lbl">Dash</span>');
        
        // Hamburger Dropdown Wrapper
        var $hamburgerDropdown = $('<div class="dropdown elite-dropdown" style="display:inline-block;"></div>');
        var $hamburgerBtn = $('<a class="btn dropdown-toggle" data-toggle="dropdown" href="#"><i class="fa fa-bars"></i><span class="btn-lbl">Menu</span></a>');
        var $dropdownMenu = $('<ul class="dropdown-menu"></ul>');

        // Helper to add items to dropdown if they exist in the original header
        function addMenuModule(selector, label) {
            var $original = $(selector);
            if ($original.length) {
                var $cloned = $original.clone(true).removeAttr('id block').removeClass('pos-tip');
                $cloned.append('<span class="btn-lbl">' + label + '</span>');
                $dropdownMenu.append($('<li style="padding: 5px;"></li>').append($cloned));
            }
        }

        // Add modules to dropdown menu
        addMenuModule('#pos_details', 'Recent');
        addMenuModule('#today_sale', 'Today');
        addMenuModule('a[href*="alert_qty"]', 'Alert Quantity');
        addMenuModule('#add_expense', 'Add Expense');
        addMenuModule('#register_details', 'Register Details');
        addMenuModule('#today_profit', "Today's Profit");
        addMenuModule('#view_purchases', 'Purchase');
        addMenuModule('#close_register', 'Close Register');

        $hamburgerDropdown.append($hamburgerBtn).append($dropdownMenu);
        $mobHeaderActions.append($btnDash).append($hamburgerDropdown);
        $('#header.navbar').append($mobHeaderActions);
    }
});
</script>
</body>
