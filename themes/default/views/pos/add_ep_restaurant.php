...
document.addEventListener("DOMContentLoaded", function() {
    const widgetContent = document.querySelectorAll(".ui-widget-content");
...
<head>
    ...
    <?php if ($Settings->theme == 'theme_four' || $Settings->theme == 'theme_six') { ?>
    <style>
    #ajaxproducts img {
   ...
   <?php
     if ($Settings->theme == 'theme_four'&& $Settings->theme == 'theme_six' && $Settings->theme == 'theme_seven' && $pos_settings->display_coinage == 1) { ?>
    ...
    <?php } ?>
    <?php
    // Load CRM CSS and JS if CRM is enabled
    if ($pos_settings->display_CRM == 1) { ?>
        <link rel="stylesheet" href="<?= $assets ?>pos/css/customer_relation.css" type="text/css" />
        <script src="<?= $assets ?>pos/js/customer_relation.js" type="text/javascript"></script>
    <?php } ?>
    ...
    <?php }  ?>
    <?php
     if ($Settings->theme == 'theme_six' && $pos_settings->display_coinage == 1) { ?>
    <link rel="stylesheet" href="<?= $assets ?>pos/css/coinage.css" type="text/css" />
    <?php }?>
    ...
    <?php } ?>
    <?php
    /* theme_six/theme_seven: coinage 0 already loads theme CSS above; coinage != 0 should still load active theme CSS */
    if (in_array($Settings->theme, ['theme_six', 'theme_seven'], true) && (int) $pos_settings->display_coinage !== 0) { ?>
    <link rel="stylesheet" href="<?= $assets ?>pos/css/<?= $Settings->theme ?>.css" type="text/css" />
    <?php } ?>
    ...
    <?php }
        ?>
    <style>
    <?php if ($Settings->theme == 'theme_seven') { ?>
    label.payment-methods, .payment-methods {
        height: 110px !important;
    }
    <?php } elseif ($Settings->theme == 'theme_six') { ?>
    label.payment-methods, .payment-methods {
    ...
    #left-bottom .btn-primary {
        background: rgba(0, 0, 0, 0);
        background: -moz-linear-gradient(top, rgb(66, 139, 202) 0%, rgb(49, 109, 161) 100%);
        background: -webkit-linear-gradient(top, rgb(66, 139, 202) 0%, rgb(49, 109, 161) 100%);
        background: -ms-linear-gradient(top, rgb(66, 139, 202) 0%, rgb(49, 109, 161) 100%);
        background: linear-gradient(to bottom, rgb(66, 139, 202) 0%, rgb(49, 109, 161) 100%);
        position: relative;
        /* padding: 6px; */
        margin-bottom: 0px;
    }
    ...
    <!-- <?php var_dump($Settings->theme);  ?> -->
    <?php if ($Settings->theme == 'theme_three') {  ?>
    <style>
        @media screen and (min-width: 1000px) and (max-width: 1030px) {

                .header-nav .nav:nth-child(2) {
                    width: 52% !important;
                }

                
                #posTable .fa-plus::before{
                    /* width: 11px; */
                    width: 9px;
                    height: 35px;
                    display: block;
...
?>
<?php
$restaurant_ep_inline_theme = isset($Settings->theme) && in_array($Settings->theme, ['theme_six', 'theme_seven'], true);
?>
<?php if ($restaurant_ep_inline_theme) { ?>
<style>
    /* Theme 6/7: customer view/edit pages loaded in #myModal should render as modal content, not full page. */
    #myModal .container,
    #myModal2 .container {
        width: auto !important;
    ...
    #myModal .content-wrapper,
    #myModal2 .content-wrapper,
    #myModal .wrapper,
    #myModal2 .wrapper,
    #myModal #content,
    #myModal2 #content {
...
<?php /* POS layout (header, filters, columns): theme_six.css / theme_seven.css */ ?>
<?php if (!empty($pos_settings->display_qr_code_scanner) && (!isset($Settings->theme) || $Settings->theme !== 'theme_seven')) { ?>
<style>
    input#add_item_qr {
        width: 144%;
    }
...
<?php if (isset($pos_settings->display_qr_code_scanner) && (int)$pos_settings->display_qr_code_scanner === 1) { ?>
<style>
    #add_item {
        width: 109%;
        margin-left: -15px;
        ...
        <header id="header" class="navbar">
            <div class="container">
                ...
                <div class="header-nav">
                    ...
                    <ul class="nav navbar-nav pull-right navs-i">
                        <!--<li class="dropdown">
                        ...
                        <li class="dropdown hidden-xs li-dashset" >
                            <a class="btn bblue pos-tip" id="dashset" style="border-radius: 20px !important; display: flex !important;justify-content: space-around;align-items: center;"
                                ...
                                <img src="<?= $assets ?>pos/images/NotificationsNew.svg" alt="Notifications"
                                    style="height: 20px; " id="notifications">                                    
                                <sup><?php echo $alertProd_Count['count']; ?></sup>
                            </a>
                        </li>
                    ...
                    <i class="fa fa-credit-card"></i>
                        ...
                        <li class="dropdown">
                            <a class="" id="today_profit" title="<?= lang('today_profit') ?>"
                                ...
                                data-toggle="modal" data-target="#myModal">
                                <i class=""></i>
                                <img src="<?= $assets ?>pos/images/TodaysProfitNew.svg" alt="Today's Profit" style="height: 22px; margin-top: -5px;">
                            </a>
                        </li>
                        <?php }
                            ?>
                        ...
                        <li class="dropdown hidden-xs book" id="setnav-section;">
                            <a class="pos-tip" title="<?= lang('list_open_registers') ?>"
                                data-placement="bottom" href="<?= site_url('pos/registers') ?>">
                                <i class=""></i>
                                <img src="<?= $assets ?>pos/images/ListOpenRegNew.svg" alt="List Open" style="height: 21px;margin-top: -3px;">
                            </a>
                        </li>
                        <li class="dropdown hidden-xs">
                            <a class="pos-tip" title="<?= lang('clear_ls') ?>" data-placement="bottom"
                                id="clearLS" href="#">
                                <i class=""></i>
                                <img src="<?= $assets ?>pos/images/ClearDataNew.svg" alt="Clear Data" style="height: 22px; margin-top: -4px;">
                            </a>
                        </li>
                        <?php
                            }
                            ...
                            if ($Settings->pos_type == 'restaurant') {
                                ?>
                        <li class="dropdown">
                            <!-- btn no-effect themeicon1 dropdown-toggle -->
                            ...
                            <ul class="dropdown-menu pull-right padding0">
                                ...
                                <li onclick="change_offerdetails('<?= $offers->id; ?>')">
                                    <a class="pointer" id="offer_detail" data-toggle="modal" data-target="#offer_modal">
                                        <?= ucfirst($offers->offer_name) ?>
                                    </a>
                                </li>
                                <?php } ?>
                            </ul>
                        ...
                        <li class="dropdown">
                            <!-- class="btn no-effect themeicon dropdown-toggle" -->
                            <a class=" dropdown-toggle" id="setnav-section" data-placement="bottom"
                            ...
                            <ul class="dropdown-menu pull-right padding0">
                                ...
                                <li onclick="change_theme('<?= $pt->theme_name; ?>')">
                                    <a class="pointer">
                    ...
                    <div style="display: flex; align-items: center; justify-content: space-between; width: 23%;">
                        ...
                        <li class="dropdown gtd" style="list-style: none; margin-right: 15px;">
                        ...
                        <li style="list-style: none; margin-right: 15px; display: flex; align-items: center;" class="ot">
                            <label for="ordertype" style="margin-right: 8px; color: #000; font-weight: bold;">Order Type:</label>
                            <select id="ordertype" class="order_type" name="ordertype" style="padding: 8px 12px; min-width: 140px; font-size: 12px;">
                                ...
                                <option value="STALL SALES">STALL SALES</option>
                            </select>
                                </li>
                            <?php endif; ?> 
                             <!-- <?php if ($Settings->pos_type == 'restaurant') : ?>
                                <button type="button" class="btn btn-info btn-block custom-print-btn" id="print_order">
                                    <?= lang('KOT'); ?>
                                </button>
                            <?php endif; ?> -->
...
//                            $this->sma->pos_error_log($logger);
                    ...
                    <div id="pos">
                        ...
                        <div id="leftdiv">
                            ...
                            <input type="hidden" value="" name="selected_Amount" id="selected_Amount" />
                            <input type="hidden" value="" name="return_Amount" id="return_Amount" />
                            ...
                            <div id="print">
                                <div id="left-middle">
                                    ...
                                    <div id="left-bottom">
                                        <?php
                                        if ($Settings->theme == 'theme_three') { ?>
                                        <table id="totalTable" style="margin-bottom: 4px;">
                                            <?php } else { ?>
                                            <table id="totalTable">
                                                <?php } ?>
                                                <tr>
                                            ...
                                            <div id="botbuttons" class="col-xs-12 text-center">
                                                ...
                                                <?php if (($pos_settings->display_coupon_code) || $GP['pos-apply_coupon']) {
                                                    $coupon_row_mb = in_array($Settings->theme, ['theme_six', 'theme_seven'], true) ? '2px' : '6px';
                                                    ?>
                                                <div class="row coupon-row" style="margin-bottom:<?= $coupon_row_mb ?>;">
                                                    <div class="col-xs-8" style="padding:0 6px 0 0;">
                                                        ...
                                                        <div id="coupon-message" class="text-success" style="display:none;font-weight:bold;text-align:left;"></div>
                                                    </div>
                                                ...
                                                <?php } ?>
                                                <?php if ($subdomain !="magicwears") {
                                                    $desc_row_mb = in_array($Settings->theme, ['theme_six', 'theme_seven'], true) ? '2px' : '6px';
                                                    ?>
                                                <div class="row margtop" style="margin-bottom:<?= $desc_row_mb ?>;">
                                                    <div class="col-xs-12" style="padding:0 6px 0 0; display:none;"
                                                    ...
                                                    <div class="col-xs-12 padding0" style="padding:0 6px 0 0;"
                                                ...
                                                <div class="row">
                                                    <div class="col-xs-4 padding0">
                                                        <div class="btn-group-vertical btn-block">
                                                            ...
                                                            <button type="button" id="suspend"
                                                                ...
                                                                Table </button>
                                                            <?php } elseif (in_array($Settings->theme, ['theme_four', 'theme_five', 'theme_six', 'theme_seven'], true)) { ?>
                                                            <button type="button"
                                                                class="btn btn-warning btn-block btn-flat"
                                                                id="suspend_sale"> Suspend </button>
                                                            <?php  } else { ?>
                                                            <button type="button"
                                                                class="btn btn-warning btn-block btn-flat" id="suspend">
                                                                Suspend </button>
                                                            <?php } ?>
                                                            ...
                                                            <button type="button"
                                                                ...
                                                                style="width: 48%;float: left; margin-left:-2px; margin-top: 2px;">
                                                                <?= lang('cancel'); ?>
                                                            </button>
                                                            <button type="button"
                                                                class="btn btn-warning btn-block btn-flat"
                                                                id="shifttable"
                                                                style="width: 50%;float: left;margin-left: 2px; ">
                                                                <?= lang('Shift'); ?>
                                                            </button>
                                                        </div>
                                                    ...
                                                    <div class="col-xs-4 padding0">
                                                        ...
                                                        <button type="button" class="btn btn-success btn-block"
                                                            id="payment">
                                                            <i
                                                                class="fa fa-money marginright5"></i><?php /* lang('payment'); */ ?>Checkout
                                                        </button>
                                                        <?php } ?>
                                                    </div>
                                                    <?php } ?>
                                                    <?php if ($pos_settingss->display_seller == 1) { ?>
                                                    <div class="col-xs-4 padding0">
                                                        <?php if ($Owner || $Admin || $GP['checkout']) { ?>
                                                        <button type="button" class="btn btn-success btn-block"
                                                            id="payment">
                                                    ...
                                                    <?php if ($pos_settingss->display_seller == 2) { ?>
                                                    <div class="col-xs-4 padding0">
                                                        <?php if ($Owner || $Admin || $GP['checkout']) { ?>
                                                        <button type="button" class="btn btn-success btn-block"
                                                            id="payment" onclick="validateCheckout()">
                                                            <i class="fa fa-money marginright5"></i>Checkout
                                                        </button>
                                                        <?php } ?>
                                                    </div>
                                            ...
                                            <input type="hidden" name="offer_on_category" value=""
                                                id="offer_on_category">
                                            <input type="hidden" name="offer_description" value=""
                                            ...
                                            <div id="payment-con">
                                                ...
                                                <input type="hidden" name="cc_month[]" id="cc_month_val_<?= $i ?>"
                                                    value="" />
                                                <input type="hidden" name="cc_year[]" id="cc_year_val_<?= $i ?>"
                                                    value="" />
                                                <input type="hidden" name="cc_type[]" id="cc_type_val_<?= $i ?>"
                                                    value="" />
                                                <input type="hidden" name="cc_cvv2[]" id="cc_cvv2_val_<?= $i ?>"
                                                    value="" />
                                                <input type="hidden" name="payment_note[]"
                                                    id="payment_note_val_<?= $i ?>" value="" />
                                                <input type="hidden" name="cc_transac_no[]"
                                                    id="cc_transac_no_val<?= $i ?>" value="" />
                                                <?php }
                                                ?>
                                            </div>
                                            ...
                                            <input type="hidden" name="paynear_mobile_app" id="paynear_mobile_app"
                                                value="" />
                                            <input type="hidden" name="paynear_mobile_app_type"
                                                id="paynear_mobile_app_type" value="" />
                                ...
                                <div id="left-top">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row" style="display: flex;">
                                            ...
                                            <div class="col-sm-4 custom-flex" style= "margin-left: -4px;">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6 ">
                                                        <div class="input-group">
                                                            <input type="text" pattern="[0-9]+" min="10" maxlength="10"
                                                            ...
                                                            <div id="sales_icon"
                                                                ...
                                                                <span disabled="true" style="padding:4px;"
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="hidden" class="nodisplay" name="customer"
                                                                id="poscustomer"
                                                                value="<?= ($_SESSION['quick_customerid'] ) ? $_SESSION['quick_customerid'] : $get_cmp->id; ?>" />
                                                            <input type="text" placeholder="Customer Name"
                                                                name="customer_name"
                                                                class="form-control kb-text kb-pad txt-box ui-keyboard-input ui-widget-content ui-corner-all ui-keyboard-autoaccepted"
                                                                id="customer_name"
                                                                value="<?= ($_SESSION['quick_customername'] ) ? $_SESSION['quick_customername'] . '(' . $_SESSION['quick_customerphone'] . ')' : $get_cmp->name; ?>" />
                                                    ...
                                                    <div class="col-sm-12 ">
                                                        <div class="select-group">
                                                            ...
                                                            <select name="sales_person" id="sales_person"
                                                                ...
                                                                onchange="return getSellerDetails(this.value);">
                                        ...
                                        <?php } elseif ($Settings->theme != 'theme_six') { ?>
                                        <div class="row" style="display: flex;">
                                            <div class="col-sm-4 custom-flex customset" style= "margin-left: -4px;">
                                                <?php $count = isset($count) ? $count : 0; ?>
                                                <?php echo form_input('scan_item_qr', $ScanId, 'class="form-control " id="scan_item_qr" placeholder=" Customer Scan"'); ?>
                                                <span id="span_value"> <?php echo $count ; ?></span>
                                            </div>
                                            ...
                                            <div class="<?php
                                                    if ($pos_settingss->display_seller == 1)
                                                        ...
                                                        echo 'col-sm-12';
                                                    ?> ">
                                                <div class="input-group mob" style="margin-top: 3px;">
                                                    <!-- <?php
                                                    ...
                                                    <div class="input-group-addon no-print"
                                                        ...
                                                        <a href="#" id="toogle-customer-read-attr"
                                                            class="external edit-customers">
                                        ...
                                        <?php }else { ?>
                                        <div class="row" style="display: flex;">
                                            <div class="col-sm-4 custom-flex customset">
                                                <?php $count = isset($count) ? $count : 0; ?>
                                                <?php echo form_input('scan_item_qr', $ScanId, 'class="form-control " id="scan_item_qr" placeholder=" Customer Scan"'); ?>
                                                <span id="span_value"> <?php echo $count ; ?></span>
                                            </div>
                                            ...
                                            <div class="<?php
                                                    if ($pos_settingss->display_seller == 1)
                                                        ...
                                                        echo 'col-sm-12';
                                                    ?> ">
                                                <div class="input-group mob" style="margin-top: 10px;">
                                                    <!-- <?php
                                                            echo form_input('customer', (($_SESSION['quick_customername'] ) ? $_SESSION['quick_customername'] . '(' . $_SESSION['quick_customerphone'] . ')' : $_GET['customer']), 'id="poscustomer"   data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("customer") . '" autofocus required="required" name="name_s2id_poscustomer" class="form-control pos-input-tip" style="width:100%;"');
                                                            ?>  -->
                                                    <input type="hidden" class="nodisplay" name="customer"
                                    ...
                                    <div class="no-print">
                                        ...
                                        <?php
                                            ...
                                            ?>
                                        <?php if (isset($_GET['seasonsId'])) {
                                            $_SESSION['seasonsId'] = $_GET['seasonsId'];
                                        } ?>
                                        <?php if (in_array($Settings->theme, ['theme_three', 'theme_four', 'theme_five', 'theme_six', 'theme_seven'])) { ?>
                                                ...
                                                <?php foreach ($categories as $category) {
                                                    ...
                                                    echo "<div class='inline-item'>
                                                            <button id='category-" . $category->id . "' 
                                                                ...
                                                                <span class='text-white' id='text-category-" . $category->id . "'>" . $category->name . "</span>
                                                            </button>
                                                        </div>";
                                                } ?>
                                            ...
                                            <div class="item-list">
                                                ...
                                                <div class="btn-group btn-group-justified pos-grid-nav">
                                                    <div class="btn-group prev">
                                                        <button
                                                            class="btn btn-primary pos-tip z-index2 <?= $disblePage ?>"
                                                    ...
                                                    <div class="btn-group next">
                                                        <button
                                                            class="btn btn-primary pos-tip z-index4 <?= $disblePage ?>"
                                                            title="<?= lang('next') ?>" type="button" id="next1"
                                                            disabled="disabled">
                                                            <i class="fa fa-chevron-right"></i>
                                                        </button>
                                                        <button
                                                            class="btn btn-primary pos-tip z-index4 <?= $enablePage ?>"
                                                    ...
                                                    echo "<div class='category-item inline-item'>
                                                        <div class='d-flx1'>
                                                            <button id='category-" . $category->id . "' 
                                                                ...
                                                                <span class='text-white custom-width' id='text-category-" . $category->id . "'>" . $category->name . "</span>
                                                            </button>
                                                        </div>
                                                    </div>";
                                                }
    ...
    <?php
        ...
        if ($Settings->theme == 'theme_three') {
            ...
            // First, check if we should load coinage or CRM
        if ($pos_settings->display_coinage == 1 && $Settings->theme != 'theme_three' && $Settings->theme != 'theme_five') {
            // Load coinage functionality
            include_once('coinage_checkout.php');
        } else {
            // Only load the default checkout model if both coinage and CRM are disabled
            if ($Settings->theme == 'theme_five' || $Settings->theme == 'theme_six' || $Settings->theme == 'theme_seven') {
                        ...
                        <table class="table table-bordered table-striped">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="text" class="form-control kb-pad selling " id="pmrp">
                                    <!-- <?= ($Owner || $Admin || $GP['cart-price_edit']) ? '' : 'readonly="readonly" onchange="return false"'; ?>> -->
                                </td>
                                ...
                                <td>
                                    ...
                                    <input type="text" class="form-control kb-pad selling" id="selling"
                                        <?= ($Owner || $Admin || $GP['cart-price_edit']) ? '' : 'readonly="readonly" onchange="return false"'; ?>>
                                </td>
                                ...
                                <td style="display: none;">
                                    ...
                                    <input type="hidden" class="form-control kb-pad selling" id="pdiscount">
                                </td>
                                <?php } ?>
                                ...
                                <td>
                                    ...
                                    <input type="text" class="form-control kb-pad selling" id="mrpdiscount">
                                </td>
                            </tr>
                        </table>
                        ...
                        <?php if ($pos_settingss->display_seller == 3 || $pos_settingss->display_seller == 4) { ?>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <?php
                                        $sr = array("" => "");
                                        if (!empty($salesperson_details)) {
                                            foreach ($salesperson_details as $seller) {
                        ...
                        <table class="table table-bordered table-striped">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="text" class="form-control kb-pad selling" id="pricediscount">
                                </td>
                            </tr>
                        </table>
                        <?php if ($Settings->tax1) {
...
?>
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control kb-pad" id="mprice" name="mprice"
                    ...
                    <div class="row">
                        <div class="col-xs-6">
                            ...
                            <div class="information-field" style="display:none">
                                <div class="row">
                                    <div class="col-md-12">
                                        <input name="carry_out_customer_info" type="text" class="form-control"
...
?>
                ...
                success: function(result) {
                    ...
                    if (result.giftcardqty && result.giftcardAmt) {
                        $('#showgiftcard').html('Gift Card: ' + result.giftcardqty + ', ' +
                            ' Gift Card Amount:  ' + result.giftcardAmt);
                    }
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    if (result.total_amount && result.paid) {
                        ...
                        $('#showdue').html('Due Amount: ' + parseFloat(due1).toFixed(2));
                    }
        ...
        $(document).on('click', '.addButton', function() {
            if (pa <= 5) {
                ...
                /* Scope to checkout modal — duplicate id="payments" exists on Return Sale modal */
                var phtml = $('#paymentModal #payments').html(),
                    update_html = phtml.replace(/_1/g, '_' + pa);
                pi = 'amount_' + pa;
                $('#multi-payment').append(
                    '<div class="multi-payment-entry clearfix">' +
        ...
        $(document).on('click', '.close-payment', function() {
            var $wrap = $(this).closest('.multi-payment-entry');
            if ($wrap.length) {
                $wrap.remove();
            } else {
                $(this).next().remove();
...
?>
        ...
        $('select, .select').not('#multiselect1, #multiselect1_to').select2({
            minimumResultsForSearch: 7
        });
...
?>
                    ...
                    if (data.row.type == 'Bundle') {
                        addcomboProducts(data, data.combo_items.id);
                        $(this).val('');
                        return true;
                    }
                    if (data !== null) {
        ...
        $(document).on('change', '.paid_by', function() {
            ...
            if (p_val == 'award_point') {
                $('.final-submit-btn').prop('disabled', true);
                $('.ap_' + pa_no).show();
                var billAmt = parseFloat($('#amount_' + pa_no).val()) || parseFloat(gtotal) || 0;
        ...
        $(document).on('click', '#submit-sale', function(e) {
            ...
            $('#pos_note').val(localStorage.getItem('posnote'));
            $('#staff_note').val(localStorage.getItem('staffnote'));
            <?php if ((int) $pos_settings->display_coinage === 1) { ?>
            ...
            if (scanValue == '' && count > 1) {
                ...
                <?php if ($sid) { ?>
                    if (kotprint_flag == true) {
                        // If order receipt is enabled
                        <?php if ($pos_settingss->order_receipt == 1) { ?>
                            printKOT();
                        <?php } else { ?>
                        // If order receipt is Disabled    
                            printKOT();
                        <?php } ?>
                        deletekotItems();
                    }
                <?php } else { ?>
                    // If No SID
                    <?php if ($pos_settingss->order_receipt == 1 || $pos_settingss->order_receipt != 1) { ?>
                        printKOT();
                    <?php } ?>
                <?php } ?>
                update_token();
...
?>
    ...
    <script type="text/javascript" src="<?= $assets ?>js/customers_add_modal.js"></script>
    ...
    <script type="text/javascript" src="<?= $assets ?>pos/js/pos.ajax_ep_restaurant.js"></script>
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.custom_payment_icon', function() {
            ...
            if (custom_payment_value == 'paynear') {
                ...
                // validated via paid_by change handler
            }
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                if (res.msg == 'AwardPointNotFound') {
                    ...
                    $('.final-submit-btn').prop('disabled', true);
                    $('#errorap_1').html(
                        '<small class="red">Award Point not added, please select other payment mode</small>'
                    );
                } else if (res.msg == 'AwardPointNotValid') {
                    $('.final-submit-btn').prop('disabled', true);
                    $('#errorap_1').html(
                        '<small class="red">you can only redeem award points worth 50% of invoice value</small>'
                    );
                } else {
                    $('.final-submit-btn').prop('disabled', true);
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-8">
                            <div class="form-group">
                                <input name="MobileNumber" readonly type="text" id="MobileNumber" class="form-control"
...
?>
    ...
    <script>
    $(document).ready(function() {
        var ap = document.getElementById('ajaxproducts');
        var il = document.getElementById('item-list');
        if (!ap || !il) return;
        <?php if (in_array($Settings->theme, ['theme_six', 'theme_seven'], true)) { ?>
        /* Theme 6/7: let theme CSS + flex layout size the grid (same idea as theme 5 / add_ep.php — no fixed %) */
        ap.style.removeProperty('height');
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data != null) {
                    ...
                    localStorage.setItem('poscustomername', data.name);
...
if ($_SESSION['Print_Deposite_Receipt']['status'] == '1') {
    ...
    function printKOT() {
        ...
        $.each(unique_array, function(index, value) {
            ...
            if (printstatus) {
            <?php if($pos_settingss->kitchen_printer == 1) { ?>
                console.log("KOT sent to Global Printer (No print preview)");
            <?php } else { ?>
                openWin(kotprint);
            <?php } ?>
            token_no++;
    ...
    $(document).ready(function() {
        $('#send-datas').click(function() {
            ...
            $('input.unitprices').each(function() {
                return_unit_price.push($(this).val());
            });
            $('input.returnquantity').each(function() {
                return_quantity.push($(this).val());
            });
            $('input.returntotal').each(function() {
                return_subtotal.push($(this).val());
            });
            $('input.return_netprice').each(function() {
                return_netprice.push($(this).val());
            });
            ...
            $('#return_quantity').val(return_quantity);
            $('#return_subtotal').val(return_subtotal);
            $('#grandtotal').val(totalValue);
            $('#totalpayable').val(totalpayable);
            $('#return_netprice').val(return_netprice);
            $('#return_hsn_code').val(hsn_code);
            $('#product_ids').val(productIds);
            $('#return_product_type').val(product_type);
            $('#return_product_code').val(product_code);
            $('#return_article_code').val(article_code);
            $('#return_product_name').val(product_name);
            $('#return_item_option').val(item_option);
            $('#return_product_discount').val(product_discount);
            $('#return_product_tax').val(product_tax);
            $('#return_item_price').val(item_price);
            $('#return_product_unit').val(product_unit);
            $('#return_product_base_quantity').val(product_base_quantity);
        ...
        <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div id="return_sale_payments_wrap">
                        <div class="row">
                            <div class="col-md-12">
...
$(document).ready(function() {
        ...
        if (count > 0) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    const suspended_bills = response.bills_data;
                    ...
                    if (response.id == userId) {
                        ...
                        // $('#checkbox_' + response.billid).prop('checked', false).prop('disabled', true);
                        suspended_bills.forEach(bill => {
                            const referenceNo = bill.reference_no;
                            if (scanValue === referenceNo) {
                                $('#checkbox_' + bill.id).prop('checked', false)
                                    .prop('disabled',
                                        true); // Disable and uncheck the checkbox
                            }
                        });
                    } else {

                        suspended_bills.forEach(bill => {
                            const suspendId = bill.id;
                            if (selectedSuspendIds.includes('checkbox_' +
                                    suspendId)) {
                                $('#checkbox_' + suspendId).prop('checked', false)
                                    .prop('disabled', true); // Disable the checkbox
                            }
                        });
    ...
    let selectedSuspendIds = [];
    $('#add-to-cart').on('click', function() {
        selectedSuspendIds = $('.bill-checkbox:checked').map(function() {
            return this.id;
...
<?php if (!in_array($Settings->theme, ['theme_three', 'theme_four', 'theme_five', 'theme_six', 'theme_seven'], true)) { ?>
<script>
...
<?php if (!empty($Settings->theme) && $Settings->theme === 'theme_three') { ?>
<script>
let activeCategory = null;
let activeIcon = null; // Store the currently active icon element
...
$(document).ready(function() {
    ...
    $('#seasons').change(function() {
        ...
        if (seasonsId == 0) {
            sessionStorage.removeItem('product_season');
        }
        window.location.href = fullUrl;

    });
    var product_season = sessionStorage.getItem('product_season');
});
var userId =
    <?php echo json_encode($this->session->userdata('user_id')); ?>;
</script>
<script type="text/javascript">
    (function($) {
        ...
        function alignTopRow() {
            ...
            // Sales Person field width fixed in all cases.
            setImportant(
                $row.find('#sales_personId .select-group, #sales_personId #sales_person, .col-sm-3 .select-group, .col-sm-3 #sales_person'),
            ...
            setImportant($middle, { 'margin-left': '0' });
            ...
            setImportant($inner.children(':visible'), {
                'padding-left': '0',
                'padding-right': '0',
                'min-width': '0'
            });
            ...
            if (isVisible($mobile) && isVisible($customer)) {
                setUnits($mobile, 0.65);
                setUnits($customer, 1.35);
                var $mobileGroup = $mobile.find('.input-group:visible').first();
                if ($mobileGroup.length) {
                    setImportant($mobileGroup, { 'margin-left': (hasScan && hasSeller) ? '-7px' : '-12px' });
                }

                // All fields ON: keep Search Customer Mobile width equal to Category field width.
                if (hasScan && hasSeller) {
                    var $categoryGroup = $('.pos-inline-filters').first().find('.col-md-3.pr-2:visible .input-group.category-set:visible').first();
                    if ($categoryGroup.length && $mobileGroup.length) {
                        var categoryWidthPx = $categoryGroup.outerWidth();
                        if (categoryWidthPx && categoryWidthPx > 0) {
                            setImportant($mobile, {
                                flex: '0 0 ' + categoryWidthPx + 'px',
                                width: categoryWidthPx + 'px',
                                'max-width': categoryWidthPx + 'px',
                                'min-width': '0'
                            });
                            setImportant($mobileGroup, {
                                width: categoryWidthPx + 'px',
                                'max-width': categoryWidthPx + 'px'
                            });
                        }
                ...
                var $six = $inner.children('.col-sm-6:visible');
                if ($six.length >= 2) {
                    /* Restaurant top row uses two col-sm-6 fields. */
                    setUnits($six.eq(0), 1);
                    setUnits($six.eq(1), 1);
                    var $mobileSix = $six.eq(0);
                    var $mobileSixGroup = $mobileSix.find('.input-group:visible').first();
                    if ($mobileSixGroup.length) {
                        setImportant($mobileSixGroup, { 'margin-left': (hasScan && hasSeller) ? '-7px' : '-12px' });
                    }

                    // All fields ON (theme 6/7 markup): match Search Customer Mobile width to Category width.
                    if (hasScan && hasSeller) {
                        var $categoryGroupSix = $('.pos-inline-filters').first().find('.col-md-3.pr-2:visible .input-group.category-set:visible').first();
                        if ($categoryGroupSix.length && $mobileSixGroup.length) {
                            var categoryWidthSixPx = $categoryGroupSix.outerWidth();
                            if (categoryWidthSixPx && categoryWidthSixPx > 0) {
                                setImportant($mobileSix, {
                                    flex: '0 0 ' + categoryWidthSixPx + 'px',
                                    width: categoryWidthSixPx + 'px',
                                    'max-width': categoryWidthSixPx + 'px',
                                    'min-width': '0'
                                });
                                setImportant($mobileSixGroup, {
                                    width: categoryWidthSixPx + 'px',
                                    'max-width': categoryWidthSixPx + 'px',
                                    'margin-left': '-7px'
                                });
        ...
        function alignBottomRow() {
            ...
            if (!$mobileTop.length && !$customerTop.length) {
                var $sixTop = $middleTop.find('> .row > .col-sm-6:visible');
                if ($sixTop.length >= 2) {
                    $mobileTop = $sixTop.eq(0);
                    $customerTop = $sixTop.eq(1);
                }
            }
            ...
            setImportant(
                $row.find('> #ui .input-group.pos-dynamic-group, > #ui .input-group.rigsid.pos-dynamic-group'),
                { display: 'flex', 'flex-wrap': 'nowrap', 'align-items': 'stretch', overflow: 'hidden' }
            );
            setImportant(
                $row.find('> #ui .input-group.pos-dynamic-group .pos-dynamic-grow, > #ui .input-group.rigsid.pos-dynamic-group .pos-dynamic-grow'),
                { flex: '1 1 0px', 'min-width': '0', 'max-width': 'none' }
            );
            setImportant(
                $row.find('> #ui .input-group.pos-dynamic-group #add_item, > #ui .input-group.pos-dynamic-group #add_item_qr, > #ui .input-group.rigsid.pos-dynamic-group #add_item, > #ui .input-group.rigsid.pos-dynamic-group #add_item_qr'),
                { width: '100%', 'max-width': '100%', 'min-width': '0' }
            );
            setImportant(
                $row.find('> #ui .input-group.pos-dynamic-group > .pos-dynamic-grow + .input-group-addon.padding28, > #ui .input-group.rigsid.pos-dynamic-group > .pos-dynamic-grow + .input-group-addon.padding28, > #ui .input-group.pos-dynamic-group .input-group-addon.padding28, > #ui .input-group.rigsid.pos-dynamic-group .input-group-addon.padding28'),
                { 'margin-left': '0', 'margin-right': '0', flex: '0 0 auto', width: 'auto' }
            );
        }
...
$('.final-submit-btn').on('click', function (e) {
    ...
    if (selectedOrderTypeText === 'Select Order Type') {
        alert('Please select an Order Type.');
        return false;
    }

    $('#hidden_ordertype').val(selectedOrderTypeText); 
});

document.addEventListener('DOMContentLoaded', function () {
    const orderTypeSelect = document.getElementById('ordertype');
    const tableBtn = document.getElementById('suspend');
    const saveBtn = document.getElementById('suspend_sale1');

    const urlParams = new URLSearchParams(window.location.search);
    const isTableSelected = urlParams.has('select_table');

    if (isTableSelected && orderTypeSelect) {
        orderTypeSelect.value = 'Dine In';
        orderTypeSelect.dataset.fromTable = 'true'; // Mark as from table
...
function openCustomerModal(selectedValue) {
    var $modal = $('#myModal');
    var returnUrl = (window.location.href || '').split('#')[0];
    var modalUrl = "<?= site_url('customers/add'); ?>" + '?type=' + encodeURIComponent(selectedValue) + '&redirect_url=' + encodeURIComponent(returnUrl) + '&t=' + new Date().getTime();
    $modal.removeData('bs.modal');
    $modal.find('.modal-content').empty();
    $modal.modal({ remote: modalUrl });
    $modal.modal('show');
}
$('#ordertype').on('change', function () {
    var selectedValue = $(this).val();
    console.log('Order type changed to:', selectedValue); // Debug log
    var tableBtn = document.getElementById('suspend');
    var saveBtn = document.getElementById('suspend_sale1');
    const tablename = localStorage.getItem("table_name");
    var skipCustomerModal = this.dataset.skipCustomerModal === '1';
    // Save selected ordertype to localStorage
    localStorage.setItem("ordertype", selectedValue);
    ...
    if (selectedValue === 'Dine In') {
        ...
        if (!this.dataset.fromTable && !tablename) {
            window.location.href = "<?= site_url('pos/kot') ?>";
        }
    } else if (selectedValue === 'delivery') {
        if (!skipCustomerModal) {
            openCustomerModal(selectedValue);
        }
    } else {
        if (tableBtn) {
            tableBtn.style.display = 'block';
    ...
    this.dataset.fromTable = '';
    this.dataset.skipCustomerModal = '';
});
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const tablename = localStorage.getItem("table_name");
    const ordertypename = localStorage.getItem("ordertype");
    ...
    if (ordertypename) {
        orderTypeSelect.dataset.skipCustomerModal = '1';
        orderTypeSelect.value = ordertypename;
        orderTypeSelect.dispatchEvent(new Event('change'));
        localStorage.removeItem("ordertype");
        return;
    }
