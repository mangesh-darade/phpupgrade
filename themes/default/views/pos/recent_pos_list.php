...
<div class="modal-dialog modal-lg no-print" style="width:95%;">
    <div class="modal-content ">
                       ...
                       <tbody>
							<?php
								...
								foreach($POSDATA as $ResValue){
									...
									$duplicate_link = anchor("sales/add?sale_id=$POSId", '<i class="fa fa-plus-circle"></i> ' . lang('duplicate_sale'), array('id'=>'SaleDetailsView'));
        $detail_link = anchor("pos/view/$POSId", '<i class="fa fa-file-text-o"></i> ' . lang('view_receipt'));
        ...
        $detail_link3 = anchor("sales/view/$POSId", '<i class="fa fa-file-text-o"></i> ' . lang('pos_details'));
        ...
        $edit_link = anchor("sales/edit/$POSId", '<i class="fa fa-edit"></i> ' . lang('edit_sale'), array('class'=>'sledit') );
        $return_link = anchor("sales/return_sale/$POSId", '<i class="fa fa-angle-double-left"></i> ' . lang('return_sale'));
