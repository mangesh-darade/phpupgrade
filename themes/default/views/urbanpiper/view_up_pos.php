        ...
        <div id="wrapper">
            <div id="receiptData">
                ...
                <div id="receipt-data" style="font-size: <?php echo $font_size; ?>pt !important">
                    ...
                    <div class="text-center">
                        ...
                        if ($Settings->invoice_view == 1) {
                            ...
                            <div class="col-sm-12 text-center">
                                <h3 style="font-weight:bold; margin: 0px;"><?= lang('Tax_Invoice'); ?></h3>
                            </div>
                            <?php
                        }
                        ?>
                    <div class="row">
                        <div class="col-sm-12">                            
                            <div class="pull-left"><?php echo lang("Order ID.") . ":&nbsp" . $inv->id; ?></div>                            
                            <div class="pull-right"><?php echo lang("Delivery Date") . ": " . $this->sma->hrld($inv->date) ;?></div>
                        </div>
                    </div> 
                    <div class="row">
                        <div class="col-sm-12"> 
                            <div><?php echo lang("Channel") . ":&nbsp" . $inv->source ?></div>
