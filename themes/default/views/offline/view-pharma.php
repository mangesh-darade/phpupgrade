   ...
   margin: 0 !important;
            ...
            @media print {
                ...
                #receipt-data{ font-size: <?php echo $font_size;?>pt;}
                 #receipt-data table{ width:95%;padding:0 2.5%;}
...
<div id="wrapper">
    ...
    <div id="receipt-data" style="font-size: <?php echo $font_size;?>px">
        <div class="text-center">
           <?php if(isset($default_printer->show_invoice_logo) && $default_printer->show_invoice_logo==1):?>
            ...
            <?php }
              ...
              if(isset($default_printer->show_tin) && $default_printer->show_tin==1 && !empty($customer->vat_no)):
		...
		<table class="table table-striped table-condensed">
		  <tbody>
			<tr>
		  <td style="width:50%"><b>Patient Name : </b> <?php echo @ucfirst($inv->cf1)?></td>
		  <td style="width:50%"><b>Doctor Name : </b> <?php echo @ucfirst($inv->cf2)?></td>
			</tr>
		  </tbody>
		</table>  
	</div>
            ...
            <?php
            	...
            	if ($Settings->invoice_view == 1) {
            	    if (!empty($tax_summary)) {
            	        ...
            	        echo '<table class="table table-condensed"><thead><tr><th >' . lang('name') . '</th><th class="text-center">' . lang('code') . '</th><th class="text-center">' . lang('qty') . '</th><th class="text-right">' . lang('tax_excl') . '</th><th class="text-right">' . lang('tax_amt') . '</th></tr></td><tbody>';
