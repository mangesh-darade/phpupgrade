                    ...
                    <div class="row">
                        <div class="col-sm-4 logo-div" >
                            <div class="logo pull-left">
                                <span class="logo1" ><a href="<?= $baseurl;?>/shop/"><img src="<?= $baseurl;?>assets/mdata/<?= $Customer_assets ?>/uploads/logos/<?= $this->Settings->logo?>" alt="Logo" class="img-responsivee" /></a></span>
                            </div>
                        </div>
                        <div class="col-sm-8 account-menu">
                            <div class="shop-menu pull-right">
                                <ul class="nav navbar-nav"> 
                                    ...
                                    ?>
                                        <li>
                                     <a href="<?php echo site_url('shop/login');?>" class="btn btn-link btn-md"><i class="fa-lock fa"></i>Login</a>
                                    </li>
                                    <?php
                                    }?>
                                </ul>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu mainmenu pull-left" aria-labelledby="dropdownMenuButton">
                                    <ul class="nav navbar-nav navbar-collapse">
                                        <li class="item">
                                            <a class="" href="<?php echo site_url('shop/index');?>">Home</a>
                                        </li>
                                         <?php if($visitor == 'user') { ?> 
                                        <li class="item">
