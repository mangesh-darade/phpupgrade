       ...
       <!--  <script src="<?= $assets . $shoptheme ?>/js/bootstrap.min.js"></script> -->
        ...
        <style>
            ...
            .w3l_banner_nav_right_banner {
                background:url(<?= base_url('assets/mdata/'.$Customer_assets.'/uploads/eshop_user/banner_1.jpg') ?>) no-repeat 0px 0px;
            ...
            .w3l_banner_nav_right_banner1{
                background:url(<?= base_url('assets/mdata/'.$Customer_assets.'/uploads/eshop_user/banner_2.jpg') ?>) no-repeat 0px 0px;
                background-size:cover;
                -webkit-background-size:cover;
                -moz-background-size:cover;
                -o-background-size:cover;
            ...
            .w3l_banner_nav_right_banner2{
                background:url(<?= base_url('assets/mdata/'.$Customer_assets.'/uploads/eshop_user/banner_3.jpg') ?>) no-repeat 0px 0px;
                background-size:cover;
                -webkit-background-size:cover;
                -moz-background-size:cover;
                -o-background-size:cover;
