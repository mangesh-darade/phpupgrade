                    ...
                    var htmlset =' <table id="qaTable2" class="table  table-bordered table-condensed table-hover table-striped dataTable">';
                        htmlset +='<thead>';
                            htmlset +='<tr>';
                                ...
                                htmlset +='<th class="col-md-2"> <?=$this->lang->line("product_batch_setting")?></th>';
                                <?php  } ?>
...
//                                            pass_variant= passvariant ;  
                               ...
                               // var checkdesable = 'FALSE';  //(result[i].item.quantity<=0)?'TRUE':'FALSE';
                                ...
                                htmlset+='<td><input class="form-control date rexpiry allcheck" name="expiry[]" autocomplete="off" disabled="ture" type="text" value="" data-id="'+result[i].item.id+''+variant_id+'" data-item="3" id="expiry_'+result[i].item.id+''+variant_id+'"></td>';
                                 <?php } ?>
                                 <?php if ($Settings->product_batch_setting) { ?>
                                htmlset+='<td><input list="batches" class="form-control" name="pbatch_number" id="pbatch_number"><datalist id="batches"></td>';
                                <?php } ?>
   ...
   // Block List Function
       ...
       function myfunction(get){
            ...
            boxdisabled('FALSE','#batches_'+get);
                                           ...
                                           class="table items table-striped table-bordered table-condensed table-hover sortable_table">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        ?>
                                                        <?php
                                                        if ($Settings->product_batch_setting) {
                                                            echo '<th class="col-md-2">' . $this->lang->line("Product_Batch") . '</th>';
                                                        }
                                                        ?>
                                                        <th class="col-md-1"><?= lang("net_unit_cost"); ?></th>
                                                        <th class="col-md-1"><?= lang("quantity"); ?></th>
                ...
                <form class="form-horizontal" role="form">
                    ...
                    <?php if ((int) $Settings->product_batch_setting) { ?>
                        <div class="form-group">
                            <label for="pbatch_number" class="col-sm-4 control-label"><?= lang('batch_number') ?></label>
                            <div class="col-sm-8" >
                            <input type="text" class="form-control" id="batchNo_div">
                            </div>
                        </div>
                    <?php } ?>
                    <div class="form-group">
...
$(document).on('change', '.subtotals', function() {
    ...
    $(this).closest('tr').find('.subtotals').val(formatMoney(subtotal.toFixed(2)));
});
