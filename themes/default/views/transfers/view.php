...
<div class="modal-dialog modal-lg no-modal-header">
    <div class="modal-content">
        <style>
        /* Cleaner print: hide UI controls, buttons and toolbars */
        @media print {
            .no-print,
            .buttons,
            .btn,
            ...
            /* Prevent link URLs from being appended in some browsers */
            a[href]:after { content: '' !important; }
            /* Remove modal paddings/borders for tight print */
            .modal-dialog, .modal-content { box-shadow: none !important; border: 0 !important; }
        }
        </style>
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover table-striped order-table">
                    ...
                    <tr>
                        ...
                        <th style="text-align:center; vertical-align:middle;"><?= lang("MRP"); ?></th>
					...
					?>
                        <tr>
                            ...
                            <td style="width: 100px; text-align:right; padding-right:10px; vertical-align:middle;"><?= $this->sma->formatMoney($row->mrp); ?></td>
                    ...
                    ?>
                        <!--  old code for without showing total quantity in transfer  model view  -->
                        ...
                        <!-- <tr>
                            ...
                            // }?>
                            <td style="text-align:right; padding-right:10px;"><?= $this->sma->formatMoney($totalMrp); ?>
                            <td style="text-align:right; padding-right:10px;"><?= $this->sma->formatMoney($totalcost); ?>
                        ...
                        <!--  new code for showing total quantity in transfer  model view  -->
                        <tr style="background:#f9f9f9; font-weight:bold;">
                            <td colspan="3" style="text-align:right;"><?= lang("total"); ?></td>
                            <td style="text-align:center;">
                            <?= $this->sma->formatQuantity($totalqty); ?>
                            </td>
                            <td style="text-align:right; padding-right:10px;">
                                <?= $this->sma->formatMoney($totalMrp); ?>
                            </td>
                            <td style="text-align:right; padding-right:10px;">
                                <?= $this->sma->formatMoney($totalcost); ?>
                            </td>
                            <?php if ($Settings->tax1) { ?>
                                <td style="text-align:right; padding-right:10px;">
