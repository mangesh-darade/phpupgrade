                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-md-12" id="sticker">
                            <div class="well well-sm">
                                <?php
                                    $sample_file = 'sample_transfer_products.xlsx';
                                    if (in_array($this->data['batch_setting'], [1, 2])) {
                                        $sample_file = 'sample_transfer_products_batch.xlsx';
                                    }
                                ?>
                               <a href="<?php echo $this->config->base_url(); ?>assets/mdata/<?php echo $Customer_assets; ?>/csv/<?php echo $sample_file; ?>"
                                    class="btn btn-info pull-right">
                                        <i class="icon-download icon-white"></i> Download Sample File
                                </a>
