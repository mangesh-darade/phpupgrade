                                ...
                                foreach ($sales as $value) {
                                    $array[$value->date] = "
                                        <table class='table table-bordered table-hover table-striped table-condensed data' style='margin:0;'>
                                            <thead></thead>
                                            <tbody>
                                                <tr><td>Gross Sale</td><td style='text-align:right;'>" . $this->sma->formatMoney($value->GrossSale + $value->return_amt + $value->total_discount) . "</td></tr>
                                                <tr><td>Return Sales</td><td style='text-align:right;'>" . $this->sma->formatMoney($value->return_amt) . "</td></tr>
                                                <tr><td>" . $this->lang->line("discount") . "</td><td style='text-align:right;'>" . $this->sma->formatMoney($value->discount) . "</td></tr>
                                                <tr><td>" . $this->lang->line("shipping") . "</td><td style='text-align:right;'>" . $this->sma->formatMoney($value->shipping) . "</td></tr>
                                                <tr style='cursor: pointer'>
                                                    <td onclick='getsaleitemstaxes(" . $year . "," . $value->date . ",\"" . date("F", mktime(0, 0, 0, $value->date, 10)) . "\")'>
                                                        " . $this->lang->line("product_tax") . " <i class='fa fa-list-alt' aria-hidden='true'></i>
                                                    </td>
                                                    <td style='text-align:right;'>" . $this->sma->formatMoney($value->tax1) . "</td>
                                                </tr>
                                                <tr><td>" . $this->lang->line("order_tax") . "</td><td style='text-align:right;'>" . $this->sma->formatMoney($value->tax2) . "</td></tr>
                                                <tr><td>" . $this->lang->line("Total") . "</td><td style='text-align:right;'>" . $this->sma->formatMoney($value->total) . "</td></tr>
                                            </tbody>
                                        </table>";
                                }
                                for ($i = 1; $i <= 6; $i++) {
