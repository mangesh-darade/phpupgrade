                ...
                <div id="filter_form">
                    ...
                    <div class="col-sm-2">
                            <div class="form-group">
                                <label class="control-label" for="report_type"><?= lang("Report Type"); ?></label>
                                <?php
                ...
                <div id="report_print_div">
                    ...
                    <div class="table-responsive" id="div_report_display">
                        <table id="SlRData"
                            ...
                            <tbody>
                                <tr>
                                     <td colspan="17" class="empty_table_body"><?= lang('loading_data_from_server') ?>
                                    </td>
                                </tr>
                            </tbody>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#xls').click(function (event) {
            ...
            window.location.href = "<?=site_url('reports_new/request_gst_report_new/')?>" + type + '/' +
    ...
    function load_gst_report() {
        ...
        var postUrl = '<?=site_url('reports_new/request_gst_report_new')?>';
