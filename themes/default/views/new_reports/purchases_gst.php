...
?>
<style>
    thead th:nth-child(13) .yadcf-filter-wrapper input
    {
    text-align:right;
...
<script type="text/javascript">
    $(document).ready(function () {
        var oTable = $('#PoRData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('reports_new/getPurchasesReportC_new/?v=1' . $v) ?>',
            ...
            'fnRowCallback': function (nRow, aData, iDisplayIndex) {
                ...
                var id = nRow.id; 
               // console.log(id);
                 var url = '<?= site_url("reports_new/getPurchaseItemsGst/") ?>?id='+id;
                    $.ajax({
                    type:'ajax',
                    dataType:'json',
                    url:url,
                    ...
                    nCells[14].innerHTML = formatMoney(result['CGST']);
                    nCells[15].innerHTML = formatMoney(result['SGST']);
                    nCells[16].innerHTML = formatMoney(result['IGST']);
                    nCells[17].innerHTML = result['VAT'] ? formatMoney(result['VAT']) : formatMoney(0);
                    nCells[18].innerHTML = result['CESS'] ? formatMoney(result['CESS']) : formatMoney(0);
                }, error:function(){
            ...
            "aoColumns": [{"mRender": fld}, null, null, null, null,null,null, {"mRender": currencyFormat}, {"mRender": currencyFormat}, null, {"mRender": currencyFormat},{"mRender": currencyFormat}, {"mRender": currencyFormat}, {"mRender": row_status},null,null,null,null,null],
            "fnFooterCallback": function (nRow, aaData, iStart, iEnd, aiDisplay) {
                ...
                for (var i = 0; i < aaData.length; i++) {
                    ...
                    taxable_amt += parseFloat(aaData[aiDisplay[i]][8]);
                    //tax_rate += parseFloat(aaData[aiDisplay[i]][11]);
                    tax_amt += parseFloat(aaData[aiDisplay[i]][10]);
               ...
               var nCells = nRow.getElementsByTagName('th');
                ...
                nCells[8].innerHTML = currencyFormat(parseFloat(taxable_amt));
                nCells[9].innerHTML = currencyFormat(parseFloat(tax_amt));
...
<style>
   #PoRData td:nth-child(8), 
   #PoRData td:nth-child(9), 
   #PoRData td:nth-child(10), 
   #PoRData td:nth-child(11), 
   #PoRData td:nth-child(12),
   #PoRData td:nth-child(14), 
   #PoRData td:nth-child(15),
   #PoRData td:nth-child(16),
   #PoRData td:nth-child(17), 
   #PoRData td:nth-child(18) 
    {
    text-align: right;
    }
</style>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    ...
                    <?php echo form_open("reports_new/purchases_gst_report"); ?>
                    <div class="row">
                ...
                <div class="table-responsive">
                    <table id="PoRData"
                        ...
                        <tr>
                           ...
                           <th><?= lang("Product Name", "Product Name"); ?></th>
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#pdf').click(function (event) {
            ...
            window.location.href = "<?=site_url('reports_new/getPurchasesReportC_new/pdf/?v=1' . $v)?>";
            return false;
        });
        $('#xls').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=site_url('reports_new/getPurchasesReportC_new/0/xls/?v=1' . $v)?>";
            return false;
        });
        $('#image').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=site_url('reports_new/getPurchasesReportC_new/0/0/xls/?v=1' . $v)?>";
            return false;
            /*event.preventDefault();
            html2canvas($('.box'), {
