...
<head>
    ...
    <title><?php echo $this->lang->line('challan') . ' ' . $inv->reference_no; ?></title>
        ...
        <div class="col-lg-12">
            ...
            <div class="col-sm-12">
                <h3 class="bold" style="text-align: center;">
                      Order Receipt
                 <?php // $this->Settings->order_receipt_label ? $this->Settings->order_receipt_label : 'Order' ?> </h3>
                <table class="table">
                    <tr>
                        <td class="bold">
                        <?php // $this->Settings->order_receipt_label ? $this->Settings->order_receipt_label : 'Order' ?>Order No.: <?= lang($inv->invoice_no ); ?>
                        <?php if (!empty($inv->return_sale_ref)) {
                        echo '<br/>'. lang("return_ref").': '.$inv->return_sale_ref;
                        } ?>
                        </td>
                        <td class="bold" style="text-align: right;"><?= lang('date'); ?>: <?= $this->sma->hrld($inv->date); ?></td>
                    </tr>
                </table>
            </div>             
...
//                      print_r($rows);exit;
				...
				$VariantPrice = $row->variant_price;
		                  ...
		                  <?php endif;?>
                            ...
                            <?php echo $this->sma->taxAttrTBL_csi_dynamic($row, 'order');?>
			...
			<div class="col-xs-12">
				<div class="col-xs-6 col-xs-offset-5" >
					<div class="order_barcodes" style="text-align:right;">
						...
						<?= $this->sma->qrcode('link', urlencode(site_url('sales/view_order/' . $inv->id)), 2); ?>
					</div>
				</div>
