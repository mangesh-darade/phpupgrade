    ...
    <html>
        <head>
            ...
            <style type="text/css" media="all">
                ...
                .table>thead>tr>th, .table>tbody>tr>th, .table>tfoot>tr>th, .table>thead>tr>td, .table>tbody>tr>td, .table>tfoot>tr>td { padding: 1px; border-collapse: collapse;}
                .well {
                        ...
                        <table style="width:100%; font-size: 13px;">
                            <tr>
                                <td class="text-left" style="width:50%;font-size: 13px; padding-left: 15px; vertical-align: top; ">
                                    <?php
                                    echo '<strong style="font-weight: bold">' . lang("Billing details ") . "</strong><br/> " . $billerDetails[0]['billing_name'] . '<br/>';
                                    if (!empty($billerDetails[0]['billing_phone'])) {
                                        echo " <b>Tel:&nbsp;</b>" . $billerDetails[0]['billing_phone'], ', ';
                                    }
                                    if (!empty($billerDetails[0]['billing_email'])) {
                                        echo " <b>Email:&nbsp;</b>" . $billerDetails[0]['billing_email'] . "<br>";
                                    }
                                    if (!empty($billerDetails[0]['billing_addr'])) {
                                        echo '<b>' . lang("address") . ":&nbsp;</b>" . $billerDetails[0]['billing_addr'];
                                    }
                                    ?>
                                </td>
                                <td class="text-left" style="width:50%;font-size: 13px; padding-left: 15px; vertical-align: top; ">
                                    <strong style="font-weight: bold"><?php echo $this->lang->line("Shipping Details"); ?></strong>
                                    <br/><span><?= $billerDetails[0]['shipping_name']; ?></span>
                                    <address>
                                         <b>Tel</b> : <?= $billerDetails[0]['shipping_phone'] ?>
                                        <b>, Email</b> : <?= $billerDetails[0]['shipping_email'] ?><br/>
