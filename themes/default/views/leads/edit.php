    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <?php echo form_input('product_sel_2', $leads->product_sel_2, 'class="form-control" id="product_sel_2"'); ?>
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                <?= lang("Product_Sel_3", "Product_Sel_3"); ?>
                <?php echo form_input('product_sel_3', $leads->product_sel_3, 'class="form-control" id="product_sel_3"'); ?>
            </div>
        </div>
