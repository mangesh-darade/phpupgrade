...
<head>
    ...
    <title>Product Details | Gulf Pharmacy</title>
    <meta name="description" content="Established in the year 1994 we Gulf Pharmacy" />
    ...
    <link href="<?= $assets ?>gulfpharmacy_theme/css/print.css" rel="stylesheet" type="text/css" media="print" charset="utf-8" />
    <link href="https://maxcdn.bootstrapcdn.com/font-awesome/4.4.0/css/font-awesome.min.css" rel="stylesheet" />
    <link href="<?= $assets ?>gulfpharmacy_theme/css/jquery-ui.min.css" rel="stylesheet" type="text/css" charset="utf-8" />
    <link href="<?= $assets ?>gulfpharmacy_theme/css/new-template.css?ver=230912_06" rel="stylesheet" type="text/css" media="screen" charset="utf-8" />
...
<body>
            ...
            <div class="product-inner-pf">
                ...
                <div class="prod-detail-div">
                    <div class="purchase-options" id="purchase-options">
                        ...
                        <p><img style="display: block; max-width:100%; margin:0 auto 15px" src="<?= $assets ?>gulfpharmacy_theme/images/guarantee-product-page.png" alt="Guarantee"></p>
                        ...
                        <!-- <div class="seals" style="margin-bottom:30px">
                            <img src="<?= $assets ?>gulfpharmacy_theme/images/icon-non-gmo.png" alt="Made with non-gmo ingredients" title="Made with non-gmo ingredients">
                            <img src="<?= $assets ?>gulfpharmacy_theme/images/icon-gluten-free.png" alt="Gluten free" title="Gluten free">
                            <img src="<?= $assets ?>gulfpharmacy_theme/images/icon-fda-registered-facility.png" alt="Made in a FDA registered facility" title="Made in a FDA registered facility">
                            <img src="<?= $assets ?>gulfpharmacy_theme/images/GMPSeal.png" alt="Current good manufacturing process" title="Current good manufacturing process">
                            <img src="<?= $assets ?>gulfpharmacy_theme/images/icon-third-party-tested.png" alt="Third party tested" title="Third party tested">
                        </div> -->
                    ...
                    <div class="info-long">
                        ...
                        <div id="product-tabs" class="product-tabs">
                            ...
                            <div id="SupplementFacts">
                                <p><img class="img-responsive" src="<?= $assets ?>gulfpharmacy_theme/images/N441_Ingredients.jpg" alt="Fermented Organic Beet Ingredients"></p>
    ...
    <script src="<?= $assets . 'gulfpharmacy_theme/js/welcome-message.js' ?>"></script>
