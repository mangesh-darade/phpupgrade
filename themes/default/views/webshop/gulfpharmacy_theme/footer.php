    ...
    <div class="container">
        <div class="row">
            ...
            <div class="row" style="margin-bottom:30px;">
                ...
                <h5><i class="fa fa-envelope"></i> Stay Updated - Gulf Pharmacy Newsletter</h5>
                ...
                <!-- <div class="col-md-6">
                <h5>We Accept:</h5>
                <img src="<?= $assets . 'gulfpharmacy_theme/images/visa.gif' ?>" alt="Visa logo">
                <img src="<?= $assets . 'gulfpharmacy_theme/images/MasterCard.gif' ?>" alt="MasterCard logo">
                <img src="<?= $assets . 'gulfpharmacy_theme/images/DiscoverCard.gif' ?>" alt="Discover logo">
                <img src="<?= $assets . 'gulfpharmacy_theme/images/Amex.gif' ?>" alt="American Express logo">
                <a href="#" title="How PayPal Works">
                    <img src="<?= $assets . 'gulfpharmacy_theme/images/paypal.jpg' ?>" border="0" alt="PayPal Logo">
                </a>
            </div> -->
            </div><!--/row-->
