...
<head>
    ...
    <meta
        name=" description"
        content="Established in the year 1994 we Gulf Pharmacy" />
    ...
    <link
        ...
        rel="stylesheet"
        type="text/css" />
    <link rel="stylesheet" type="text/css" href="<?= $assets ?>gulfpharmacy_theme/css/main.css?ver=210616_01" />
    <link rel="stylesheet" type="text/css" href="<?= $assets ?>gulfpharmacy_theme/css/print.css" />
    <link
        href="https://maxcdn.bootstrapcdn.com/font-awesome/4.4.0/css/font-awesome.min.css"
        rel="stylesheet" />
    <link rel="stylesheet" type="text/css" href="<?= $assets ?>gulfpharmacy_theme/css/jquery-ui.min.css" />
    <link rel="stylesheet" type="text/css" href="<?= $assets ?>gulfpharmacy_theme/css/new-template.css?ver=230912_06" />
    <link rel="stylesheet" href="home.css" />
    <link rel="stylesheet" type="text/css" href="<?= $assets ?>gulfpharmacy_theme/css/slick-slider.css" />
    <link rel="stylesheet" href="<?= $assets ?>gulfpharmacy_theme/css/common.css">
    <link rel="stylesheet" href="<?= $assets ?>gulfpharmacy_theme/css/index.css">
...
<body>
    ...
    <div class="container splash">
        <div class="splash">
            ...
            <h5 style="text-align:center; color:#000000; margin-bottom:10px;">
                Disclaimer: This is a staging/test website created for demonstration and development purposes only. 
                It is not an active commercial website. Any content, pricing, or transactions displayed are fictitious 
            ...
            <h1 style="
                ...
                text-align:center;
            ">
                Gulf Pharmacy : Premium Liver, Kidney, and Immune Support Supplements.
            </h1>
    ...
    <div class="container">
        <h1
            ...
            margin: 10;
            " class="text-ban-be">
            Welcome to Gulf Pharmacy - Your Partner in Health Since 1994
        </h1>
        <br />
        <p>
            <?php
    ...
    if ($homePageCompanyUpdatesSection)
        ...
        <p>
            ...
            <strong>immune system support</strong>, Gulf Pharmacy has the
        ...
        <p>
            ...
            range of
            <strong>Gulf Pharmacy at
                <a class="company-link">herbinnmicromedicines.com</a></strong>.
        </p>
    </div> -->

        <?php if (!empty($homePageCompanyCertificationSection['page_text']) || !empty($homePageCompanyCertificationSection['page_file'])) { ?>
            <div
                ...
                <div class="container">
                    ...
                    <div class="col-sm-4" style="margin-bottom: 20px">
                        <img
                            ...
                            alt="GMPSeal" />
                        <p>
                            All ingredients used are of the highest quality, and all Gulf Pharmacy supplements are manufactured in the USA under strict
        ...
        <script src="<?= $assets . 'gulfpharmacy_theme/js/jquery.magnific-popup-new.min.js' ?>"></script>
        <script src="<?= $assets . 'gulfpharmacy_theme/js/welcome-message.js?ver=221017_01' ?>"></script>
        <script src="<?= $assets . 'gulfpharmacy_theme/js/jquery.scrolldepth.min.js' ?>"></script>
        <script>
            jQuery(function() {
                jQuery.scrollDepth();
            });
        ...
        <script defer type="text/javascript" src="<?= $assets ?>gulfpharmacy_theme/js/index.js"></script>
        <script defer type="module/javascript" src="<?= $assets ?>gulfpharmacy_theme/js/common.js"></script>
