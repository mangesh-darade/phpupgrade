...
<head>
    ...
    <title>Checkout - Gulf Pharmacy</title>
    ...
    <link href="<?= $assets ?>gulfpharmacy_theme/css/main.css?ver=20090901" rel="stylesheet">
    <link href="https://maxcdn.bootstrapcdn.com/font-awesome/4.4.0/css/font-awesome.min.css" rel="stylesheet">
    <link href="<?= $assets ?>gulfpharmacy_theme/css/jquery-ui.min.css" rel="stylesheet" type="text/css" charset="utf-8">
    <link href="<?= $assets ?>gulfpharmacy_theme/css/shop-tweaks.css" rel="stylesheet" type="text/css" charset="utf-8">
    ...
    <link href="<?= $assets ?>gulfpharmacy_theme/css/common.css" rel="stylesheet" type="text/css" media="screen" charset="utf-8" />
...
<body class="" style="top: 100px;">
            ...
            <div class="main-row">
                <div class="main-content shop-bill-ship">
                    ...
                    <form name="checkout" id="custinfoform" class="form form-horizontal" method="post" action="<?= base_url('webshop/submit_order') ?>" novalidate>
                        ...
                        <div class="seals">
                            <!-- <img src="<?= $assets ?>gulfpharmacy_theme/images/secure-credit-card-payment.jpg" alt="Secure credit card payment" title="Secure credit card payment" class="img-responsive secure-cc"> -->
                ...
                <div class="main-sidebar">
                    ...
                    <h3>Testimonial</h3>
                    <div class="review">
                        <p>I was a previous customer and I made a mistake typing in my shipping address. Someone from Gulf Pharmacy noticed the difference and reached out to verify what I typed was correct to make sure I received my order. A+ service</p>
    ...
    <script type="text/javascript" src="<?= $assets ?>gulfpharmacy_theme/js/jquery.validate.min.js"></script>
