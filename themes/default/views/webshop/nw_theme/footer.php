<footer>
    <div class="container">
        <div class="row">
            ...
            <p class="contact"><strong>Questions?</strong> Call our friendly customer service team at <strong><a href="#" class="website-phone-number"><?= !empty($phone_number) ? $phone_number : "00-0000-0000" ?> </a></strong><br>
            ...
            <div class="row f-links">
                ...
                <div class="col-xs-6 col-sm-3 col-md-2 column">
                    <h5>Your Account</h5>
                    <ul>
                        <li ><a class="underline" href="<?= baseurl('webshop/your_account') ?>">Manage Account</a></li>
