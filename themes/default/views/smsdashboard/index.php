        ...
        <div class="dabhboard-outer clearfix">
            <div class="row">
                <div class="col-sm-3 tab-outer-column">
                    <div class="tab-outer">
                        <ul id="myTab" class="nav nav-tabs ">
                            ...
                            <li class=""><a href="#whatsapp" class="tab-grey"><i class="fa fa-whatsapp" aria-hidden="true"></i> <?= lang('WhatsApp') ?></a></li>
                ...
                <div class="tab-content col-sm-9 col-sm-offset-3">
                    ...
                    <div id="whatsapp" class="tab-pane fade in">
                       <?php include_once __DIR__.'/whatsapp.php';?>
                    </div>
