...
<head>
    ...
    <script type="text/javascript" src="<?= $assets ?>production_unit/js/bill_of_material.js?v=<?= time(); ?>"></script>
...
document.getElementById('sale_unit').addEventListener('input', function () {
 ...
 const minBatchQtyInput = document.getElementById('min_batch_qty');
    ...
    // SALE UNIT → Allow ONLY numbers & decimals
    $("#sale_unit").on("input", function () {
        let value = $(this).val();

        // Remove everything except digits and decimal point
        value = value.replace(/[^0-9.]/g, "");

        // Block multiple decimals (allow only one)
    ...
    // ALSO prevent alphabet or special char keypress
    $("#sale_unit").on("keypress", function (e) {
