...
<head>
    ...
    <script type="text/javascript" src="<?= $assets ?>production_unit/js/receive_delivery.js"></script>
                        ...
                        <div class="tab-pane fade in active text-center" role="tabpanel">
                            ...
                            <div class="col-md-12 p-0">
                                ...
                                <button class="btn update_order TabClick" id="update_order"
                                    style="display: none; border: 2px solid #039be5; margin:0.8rem;" data-id=""
                                    value="update_order" type="submit">Update Order</button>
                                <button class="btn add_note" id="add_note"
                                    style="display: none; border: 2px solid #039be5; margin:0.8rem;" value="place_order"
                                    type="submit">Add Note
                                </button>
                              
                                <button class="btn  TabClick" id="reject"
                                    style="display: none;color:#fff; background:#A00000; margin:0.8rem; box-shadow: inset 2px 2px 2px 0px rgba(255, 255, 255, .5), 7px 7px 20px 0px rgba(0, 0, 0, .1), 4px 4px 5px 0px rgba(0, 0, 0, .1); margin:0.8rem;" data-id=""
                                    value="reject" type="submit">Reject
                                </button>
                                <button class="btn update_order TabClick" id="received_order"
                                    style="display: none; color:#fff; background:#039be5; margin:0.8rem; box-shadow: inset 2px 2px 2px 0px rgba(255, 255, 255, .5), 7px 7px 20px 0px rgba(0, 0, 0, .1), 4px 4px 5px 0px rgba(0, 0, 0, .1)"
                                    data-id="" value="received_order" type="submit">Accept
                                </button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mrgn-tp padding-set">
                        <ul class="menu-list recent" style="display: none;">
                            <li class="btn set-bdr-none">
                                ...
                                <span class="catName"
                                    style="background-color: #009DFF; padding: 5px 2rem; color: white; border-radius:0.3rem; width:100%;"></span>
