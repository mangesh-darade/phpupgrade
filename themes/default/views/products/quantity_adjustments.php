...
<script>
    $(document).ready(function () {
        oTable = $('#dmpData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('products/getadjustments/'.($warehouse_id ? str_replace(",","_", $warehouse_id)  : '')); ?>',
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-filter"></i><?= lang('quantity_adjustments').' ('.($warehouse ? (isset($warehouse[$warehouse_id]->name)?$warehouse[$warehouse_id]->name:lang('all_warehouses'))  : lang('all_warehouses')).')'; ?></h2>
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        ...
                        <?php
                            if($Owner || $Admin || $GP['products-adjustments_byCSV']){
                        ?>
                        <li>
