...
<style>
    ...
    #warehouse-quantity-view-table tbody td:nth-child(2),
    #vendor-quantity-view-table tbody td:nth-child(2) {
        text-align: right !important;
    }
...
<?php if ($Owner || $Admin || ($this->session->userdata('view_right'))=='1') { 
   ...
   ?>
    <ul id="myTab" class="nav nav-tabs">
        ...
        <li class=""><a href="#stk-details" class="tab-grey"><?= lang('Stock Transactions') ?></a></li>
        ...
        <?php if ($product->type == 'standard' || $product->type == 'raw' || $product->type == 'Intermediate') { ?>
            ...
            <?php if($Settings->product_batch_setting > 0) { ?>
                <?php if ($this->Owner || $this->Admin ) { ?><li class=""><a href="#batches" class="tab-grey"><?= lang('Batches') ?></a></li><?php } ?>
            <?php } ?>
        <?php } ?>
    </ul>
            ...
            <div class="box-content">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="row">
                            <div class="col-sm-5">
                                <i class="fa fa-heart prod-view <?= ($product->is_featured == '1') ? 'remove-fav-product' : 'add-fav-product' ?>"></i>
                            ...
                            <div class="col-sm-7">
                                <div class="table-responsive">
                                    <table class="table table-borderless table-striped dfTable pd-table-pv table-right-left">
                                        <tbody>
                                            <!-- <tr>
                                                <td colspan="2" style="background-color:#FFF;"></td>
                                            </tr> -->
                                            <tr>
                                                <td ><?= lang("barcode_qrcode"); ?></td>
                                                <td >
                                            ...
                                            <?php } ?>
                                            <tr>
                                                    <td><?= lang("Packing Size"); ?></td>
                                                    <td><?php echo $product->packing_size; ?></td>
                                            </tr>
                                            <tr>
                                                <td><?= $product->storage_type == 'packed' ? lang("Products Quantity") : 'Product Stocks'; ?></td>
                                                <td><div class=""><?= $this->sma->formatQuantity($product->quantity); ?><?= $unit->code ?></div> 
                                                <!-- <div class=""><a class="btn btn-primary btn-xs" href="<?= base_url("products/sync_product_stocks/".$product->id.'/'.$product->storage_type)?>"><i class="fa fa-exchange"></i> Sync Quantity</a></div> -->
                                            </td>
                                            </tr>
                                            ...
                                            <?php
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php
                                                        foreach ($colors as $color) {
                                                            echo '<span class="label label-primary">' . $color->name . '</span> ';
                                                        } ?>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                ...
                                <div class="row">
                                    <div class="col-sm-5">
                                        ...
                                        <?php if ((!$Supplier || !$Customer) && !empty($warehouses) && $hasNonVendorStock && ($product->type == 'standard' || $product->type == 'raw' || $product->type == 'Intermediate')) { ?>
                                            ...
                                            <div class="table-responsive">
                                                <table
                                                    id="warehouse-quantity-view-table" class="table table-bordered table-striped table-condensed dfTable hide-dt-sort-icons">
                                                    <thead>
                                                        <tr>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        foreach ($warehouses as $warehouse) {
                                                            // if ($warehouse->quantity != 0) {
                                                                echo '<tr><td>' . $warehouse->name . ' (' . $warehouse->code . ')</td><td style="text-align:center; vertical-align:middle;"><strong>' . $this->sma->formatQuantity($warehouse->quantity) . '</strong>' . ($warehouse->rack ? ' (' . $warehouse->rack . ')' : '') . ' ' . $unit->code . '</td></tr>';
                                                            // }
                                    ...
                                    <div class="col-sm-7">
                                        ...
                                        <?php } ?>
                                        <!-- if (!empty($options) && $product->storage_type == 'packed')  -->
                                        <?php if (!empty($options)) { ?>
                                            <h3 class="bold"><?= lang('product_variants_quantity'); ?></h3>
                                            <div class="table-responsive">
                                                <table id="warehouse-variant-quantity-view-table" class="table table-bordered table-striped table-condensed dfTable hide-dt-sort-icons">
                                                    <thead>
                                                        <tr>
                                                            <th><?= lang('warehouse_name') ?></th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        foreach ($options as $option) {
                                                            ...
                                                            if (isset($option->wh_name) && !isset($activeWarehouseNames[(string)$option->wh_name])) {
                                                                continue;
                                                            }
                                                            // if ($option->wh_qty != 0) {
                                                                ...
                                                                echo '<td class="text-right">' . $this->sma->formatMoney($option->mrp) . '</td></tr>';
                                                            // }
                                                        }
                                                        ?>
                                                    </tbody>
                            ...
                            <?php if ((!$Supplier || !$Customer) && !empty($suppliers) && $hasVendorStock && ($product->type == 'standard' || $product->type == 'raw' || $product->type == 'Intermediate')) { ?>
                                <div class="col-sm-6">
                                    ...
                                    <div class="table-responsive">
                                        <table id="vendor-quantity-view-table" class="table table-bordered table-striped table-condensed dfTable two-columns hide-dt-sort-icons">
                                            <thead>
                                                <tr>
                                                    <th><?= lang('warehouse_name') ?></th>
                                                ...
                                                if ($Settings->product_batch_setting > 0 && !empty($purchase)) {
                                                    ...
                                                    if (!empty($sGroup)) {
                                                        foreach ($sGroup as $wid => $batches) {
                                                            ...
                                                            echo '<td class="product-content2">';
                                                            $sw_total = isset($sTotals[$wid]) ? (float)$sTotals[$wid] : 0; $i = 1;
                                                        ...
                                                        foreach ($suppliers as $supplier) {
                                                            echo '<tr>'
                                                                ...
                                                                . '<td><strong>' . $this->sma->formatQuantity($supplier->quantity) . '</strong>'
                                                    ...
                                                    foreach ($suppliers as $supplier) {
                                                        echo '<tr>'
                                                            . '<td>' . $supplier->name . ' (' . $supplier->code . ')</td>'
                                                            . '<td style="text-align:center">' . $this->sma->formatQuantity($supplier->quantity) . ($supplier->rack ? ' (' . $supplier->rack . ')' : '') . '</td>'
                                                            . '</tr>';
                                                    }
                                                }
                                                ?>
                            ...
                            <!-- <div class="col-sm-12"> -->
                                <!-- <div class="panel panel-info">
                                    <?php if (!empty($stocks) && count($stocks)) { ?>
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($stocks as $purchase) {
                                                        ...
                                                        $actionBy = (!empty($purchase->purchase_id) ? 'Purchase' : (($purchase->transfer_id) ? 'Transfer' : (($purchase->adjustment_id) ? 'Adjustment' : 'NA')));
                                                        ?>
                                                        <tr>
                                                             <td><?= $purchase->date ?></td> 
                                                        <?php if($Settings->product_batch_setting > 0) { ?>       
                                                        ...
                                                        <?php } ?>    
                                                            ...
                                                            <td style="text-align:center;"><?= number_format($purchase->quantity,2) ?></td>
                                                            <td style="text-align:center;"><?= number_format($purchase->quantity_balance,2) ?></td>
                                                ...
                                                <tfoot>
                                                    ...
                                                    <?php if($Settings->product_batch_setting > 0) { echo '<th></th>'; } ?>  
                                                        ...
                                                        <th></th>
                                                        <th></th>
                                                        <th style="text-align:center;"><?= number_format($totalBalanceQty,2) ?></th>                                                        
                                                        <th></th>
                                                        <th></th>
                                                    </tr>
                                                </tfoot>
    ...
    <?php } ?>
                    ...
                    var oTable = $('#SlRData').dataTable({
                        ...
                        "aoColumns": [{"mRender": fld}, null, null,null, null, null, {
                            ...
                            {"mRender": function(data) {
                                ...
                                $(td).addClass('amount-align');
                            }},                            
                            {"mRender": currencyFormat, "bVisible": false ,  "createdCell": function (td) {
                                $(td).addClass('amount-align');
                            }},
                             {"mRender": function(data) {
                                    return currencyFormat(data);  
                                }, "bVisible": false,  "createdCell": function (td) {
                                $(td).addClass('amount-align');
                            }},
                            {"mRender": row_status}
                         ],
                                ...
                                <table id="SlRData" class="table table-bordered table-hover table-striped table-condensed">
                                    ...
                                    <tfoot class="dtFilter">
                                        <tr class="active">
                                            ...
                                            <th class="amount-align"><?= lang("grand_total"); ?></th>
                                            <th><?= lang("paid"); ?></th>
                                            <th><?= lang("balance"); ?></th>
                                            <th></th>
                                        </tr>
            ...
            <script type="text/javascript">
                $(document).ready(function () {
                    var oTable = $('#ChlRData').dataTable({
                        ...
                        'fnRowCallback': function (nRow, aData, iDisplayIndex) {
                            nRow.id = aData[12];
                            nRow.className = (aData[10] > 0) ? "challan_link2" : "challan_link2 warning";
                            return nRow;
                        },
                        "aoColumns": [{"mRender": fld}, null, null, null, null, null, null, {
                                "bSearchable": false,
                                "mRender": pqFormat
                            }, {"mRender": function(data) {
                                        return currencyFormat(data); 
                ...
                $(document).ready(function () {
                    var oTable = $('#PoRData').dataTable({
                        ...
                        "aoColumns": [{"mRender": fld}, null, null, null, {
                            ...
                            //  {"mRender": currencyFormat}, {"mRender": currencyFormat, "bVisible": false}, {"mRender": currencyFormat, "bVisible": false}, 
                            {"mRender": function(data) {
                                        return currencyFormat(data); 
                                        },
                                "createdCell": function (td) {
        ...
        <div id="stk-details" class="tab-pane fade">
                    <div class="panel panel-info">
                        <?php if (!empty($stocks) && count($stocks)) { ?>
                            <div class="panel-heading">Product Warehouse Stock In Transactions</div>
                            <div class="panel-body">
    ...
    <script type="text/javascript">
                $(document).ready(function () {
                    ...
                    function initProductViewDataTable(selector) {
                    ...
                    initProductViewDataTable('#warehouse-quantity-view-table');
                    initProductViewDataTable('#vendor-quantity-view-table');
                    initProductViewDataTable('#warehouse-variant-quantity-view-table');
