        ...
        <div class="modal-body">
            ...
            <div class="well well-sm">
                <div class="row bold">
                    ...
                    <div class="col-xs-7 text-right order_barcodes">
                        ...
                        <?= $this->sma->qrcode('link', urlencode(site_url('products/view_adjustment/' . $inv->id)), 2); ?>
                    </div>
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover table-striped print-table order-table">
                    ...
                    ?>
                     <tr>
                        <td colspan="4" style="text-align:right; padding-right:120px;"><b><?= lang("total"); ?></b>
                        </td>
                       <td style="width: 80px; text-align:center; vertical-align:middle;"><?= $this->sma->formatQuantity($totalqty); ?></td>
                        </tr>
                    <?php } ?>
                    </tbody>
                </table>
