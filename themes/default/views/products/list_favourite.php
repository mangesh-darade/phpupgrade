...
<script>
    ...
    "aaSorting": [[2, "asc"], [3, "asc"]],
            ...
            'sAjaxSource': '<?= site_url('products/getFavProducts' . ($warehouse_id ? '/' . $warehouse_id : '')) ?>',
            ...
            productname = $("td:eq(3)", nRow).text()
                    $("td:eq(3)", nRow).html('<i class=\"fa fa-heart\"></i>' + productname);
            favClass = 'remove_fav'
            } else{
...
?>
                                ...
                                <th><?= lang("unit") ?></th>
                                <th><?= lang("rack") ?></th>
                                <th><?= lang("alert_quantity") ?></th> <th></th>
