                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="row">
                                    <div class="col-sm-5">
                                        ...
                                        ?>
                                        <?php if ((!$Supplier || !$Customer) && !empty($warehouses) && $hasNonVendorStock && ($product->type == 'standard' || $product->type == 'raw')) { ?>
                            ...
                            <?php if ((!$Supplier || !$Customer) && !empty($suppliers) && $hasVendorStock && ($product->type == 'standard'|| $product->type == 'raw')) { ?>
                                <div class="col-sm-6">
