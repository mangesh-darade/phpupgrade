        ...
        <div class="row">
            ...
            <div class="col-sm-3">
                <?php if ($product->image != 'no_image.png') { ?><img
                    src="<?= base_url() ?>assets/mdata/<?= $Customer_assets ?>/uploads/<?= $product->image ?>" alt="<?= $product->name ?>"
                     height="30%" width="30%" /><?php } ?><!-- class="img-responsive img-thumbnail" -->
            </div>
            <div class="col-sm-9">
                <div class="clearfix"></div>
                <h3 class="bold"><?= lang('Product_Details'); ?></h3>
                                ...
                                <table class="table table-bordered table-striped table-condensed dfTable two-columns">
                                    ...
                                    <?php foreach ($warehouses as $warehouse) {
                                        if ($warehouse->quantity != 0) {
                                            echo '<tr><td>' . $warehouse->name . ' (' . $warehouse->code . ')</td><td style="text-align:center;"><strong>' . $this->sma->formatQuantity($warehouse->quantity) . '</strong>' . ($warehouse->rack ? ' (' . $warehouse->rack . ')' : '') . '</td></tr>';
                                        }
                                    } ?>
                                    </tbody>
                                </table>
