    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo form_open_multipart("products/add_adjustment_by_csv", $attrib);
                ?>
                <div class="row">
                    <div class="col-lg-12">
                        <?php if ($Owner || $Admin) { ?>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="well well-small">
                                <?php
                                $sample_file = 'sample_adjustments.csv';
                                $columns = lang("product_code") . ', ' . lang("quantity") . ', ' . lang("variant");
                                if ((int)$Settings->product_batch_setting > 0) {
                                    $sample_file = 'sample_adjustments_batch.csv';
                                    $columns .= ', ' . lang("batch_number");
                                }
                                ?>
                                <a href="<?php echo base_url(); ?>assets/mdata/<?php echo $Customer_assets; ?>/csv/<?php echo $sample_file; ?>"
                                 class="btn btn-primary pull-right"><i
                                 class="fa fa-download"></i> <?= lang("download_sample_file") ?></a>
                                 <span class="text-warning"><?= lang("csv1"); ?></span><br/><?= lang("csv2"); ?> <span
                                 class="text-info">(<?= $columns; ?>
                                 )</span> <?= lang("csv3"); ?>
                             ...
                             <div class="form-group">
                                ...
                                <input type="file" data-browse-label="<?= lang('browse'); ?>" name="csv_file" class="form-control file" data-show-upload="false" data-show-preview="false" id="csv_fileonly" required="required"/>
                            </div>
...
<script>
$('#csv_fileonly').change(function (e) {
    ...
    if (v != '') {
        ...
        if (validExts.indexOf(fileExt) < 0) {
            ...
            $('form[data-toggle="validator"]').bootstrapValidator('updateStatus', 'csv_fileonly', 'NOT_VALIDATED');
            return false;
        } else
            return true;
    }
