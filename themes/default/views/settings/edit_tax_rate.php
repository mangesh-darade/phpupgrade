            ...
            <p><?= lang('enter_info'); ?></p>
             <div class="row">
                 <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <label class="control-label" for="surcharge_rate"><?php echo $this->lang->line("surcharge_rate"); ?></label>
                        <div class="controls"> 
                            <?php echo form_input('surcharge_rate', isset($tax_rate->surcharge_rate) ? $tax_rate->surcharge_rate : '', 'class="form-control numaric_input" id="surcharge_rate"'); ?>
                        </div>
                    </div>
                 </div>
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls">
                            ...
                            $surcharge_type_val = (isset($tax_rate->surcharge_type) && $tax_rate->surcharge_type !== '' && $tax_rate->surcharge_type !== NULL) ? $tax_rate->surcharge_type : '1';
                            echo form_dropdown('surcharge_type', $surcharge_type, $surcharge_type_val, 'class="form-control" id="surcharge_type"'); ?> 
                        </div>
                    </div>
                </div>
            </div>
