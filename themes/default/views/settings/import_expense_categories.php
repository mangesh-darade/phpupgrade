...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        $sample_file = FCPATH . 'assets/mdata/' . $Customer_assets . '/csv/sample_expense_categories.csv';
        $sample_version = file_exists($sample_file) ? filemtime($sample_file) : time();
        ?>
        <div class="modal-body">
            <a href="<?php echo base_url(); ?>assets/mdata/<?php echo $Customer_assets; ?>/csv/sample_expense_categories.csv?v=<?php echo $sample_version; ?>" class="btn btn-primary pull-right">
            ...
            <div class="well well-small">
                ...
                <span class="text-info">
                    (<?= lang("code") . ', ' . lang("name") . ', Parent Category Code (optional)'; ?>)
                </span> <?= lang("csv3"); ?>
            </div>
