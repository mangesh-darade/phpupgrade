                    ...
                    <div class="row form-group all">
                        ...
                        <div class="col-sm-6 col-xs-12 form-group"> 
                            <div class="col-sm-12 col-xs-12">
                                ...
                                $printer_bill_order_or_source_label = $_otl_order_mode ? lang('show_order_type') : lang('show_sale_source');
                                ?>
                                <input type="checkbox" <?php echo!empty($printer_option->show_order_type) ? 'Checked' : ''; ?>  value="1" name="show_order_type">
                                <b style="text-transform: capitalize;"> <?= $printer_bill_order_or_source_label; ?> <img src="<?= base_url('themes/default/assets/images/new.gif')?>" height="30px" alt="new"></b>
                            </div>
                        </div>  
                        <div class="col-sm-6 col-xs-12 form-group"> 
                             <div class="col-sm-12 col-xs-12">
                        ...
                        <div class="col-sm-6 col-xs-12 form-group">
                            <div class="col-sm-12 col-xs-12">
                                <input type="checkbox" <?php echo !empty($printer_option->show_invoice_lines) ? 'Checked' : ''; ?> value="1" name="show_invoice_lines">
                                <b style="text-transform: capitalize;"> Show Lines on Invoice</b>
                            </div>
                        </div>                      
                        <div class="col-sm-6 col-xs-12 form-group"> 
                            <div class="col-sm-12 col-xs-12">
                                <input type="checkbox" <?php echo !isset($printer_option->invoice_display_time) || !empty($printer_option->invoice_display_time) ? 'Checked' : ''; ?> value="1" name="invoice_display_time">
                                <b style="text-transform: capitalize;"> Display Time <img src="<?= base_url('themes/default/assets/images/new.gif')?>" height="30px" alt="new"></b>
                            </div>
                        </div>
                        <div class="col-sm-6 col-xs-12 form-group"> 
                            <div class="col-sm-12 col-xs-12">
                                <input type="checkbox"
                                    <?php echo !empty($printer_option->display_category) ? 'Checked' : ''; ?>
                                    value="1"
                                    name="display_category">
                                <b style="text-transform: capitalize;">
                                    <?= lang("Display Category"); ?>
                                    <img src="<?= base_url('themes/default/assets/images/new.gif')?>" 
                                        height="30px" 
                                        alt="new">
                                </b>
                            </div>
                        ...
                        <div class="col-sm-6 col-xs-12 form-group"> 
                            <div class="col-sm-12 col-xs-12">
                                <input type="checkbox" <?php echo!empty($printer_option->show_transporter_details) ? 'Checked' : ''; ?>  value="1" name="show_transporter_details">
                                <b style="text-transform: capitalize;"> <?= lang("Show Transporter details"); ?> <img src="<?= base_url('themes/default/assets/images/new.gif')?>" height="30px" alt="new"></b>
                            </div>
                        </div>
                        <div class="col-sm-6 col-xs-12 form-group"> 
                            <div class="col-sm-12 col-xs-12">
                                <?php
                                    $show_discount_in_percentage_opts = array(
                                        '0' => 'In Amount',
                                        '1' => 'In Percentage',
                                        '2' => 'Both amount and percentage',
                                    );
                                    $show_discount_in_percentage_val = isset($printer_option->show_discount_in_percentage) ? (string) $printer_option->show_discount_in_percentage : '0';
                                ?>
                                <b style="text-transform: capitalize;">Show discount as <img src="<?= base_url('themes/default/assets/images/new.gif')?>" height="30px" alt="new"></b>
                                <?php echo form_dropdown('show_discount_in_percentage', $show_discount_in_percentage_opts, $show_discount_in_percentage_val, 'class="form-control" style="width:60%;"'); ?>
                            </div>
                        </div>                                 
                    </div>                     
                </fieldset>	
