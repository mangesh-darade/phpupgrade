...
<script>
    $(document).ready(function () {
        ...
        function price_input(x) {
            ti = ti+1;
            var v = x.split('__');
            var price_val = (v[1] !== '' && v[1] !== null && v[1] !== 'null') ? formatDecimals(v[1]) : '';
            return "<div class=\"text-center\"><input type=\"text\" name=\"price"+v[0]+"\" value=\""+price_val+"\" class=\"form-control text-center price input-xs\" tabindex=\""+(ti)+"\" style=\"padding:2px;height:auto;\"></div>"; // onclick=\"this.select();\"
        }
