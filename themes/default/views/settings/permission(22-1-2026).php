                                        ...
                                        <td>
                                            ...
                                            <div class="col-sm-5">
                                                    ...
                                                    <label for="raw_materials"
                                                           class="padding05"><?= lang('List Raw Materials') ?></label>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                                ...
                                <div class="row">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="5">
                                            ...
                                            <label for="sales" class="padding05"><?= lang('Sales Transaction Report') ?></label>
                                        </div>
                                                <div class="col-sm-4">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-4">
                                                    <input type="checkbox" value="1" class="checkbox" id="reports-cash-transaction-report"
