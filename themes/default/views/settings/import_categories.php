...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <a href="<?php echo base_url(); ?>assets/mdata/<?php echo $Customer_assets; ?>/csv/sample_categories.csv" class="btn btn-primary pull-right">
            ...
            <div class="well well-small">
                ...
                <span class="text-info">
                    (<?= lang("code") . ', ' . lang("name") . ', ' . lang("image"). ', ' . lang("parent_category_code"). ', ' . lang("up_category"). ', ' . lang("tax_rate"). ', ' . lang("flag_visible"); ?>)
                </span> <?= lang("csv3"); ?><br>
                <strong><?= lang("categories_import_tip"); ?></strong>
            </div>
