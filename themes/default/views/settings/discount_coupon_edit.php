            ...
            <div class="col-lg-12">
                ...
                <fieldset class="scheduler-border">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <?= form_input('coupon_code', $CouponInfo->coupon_code, 'placeholder="Coupon Code" class="form-control" required = "required"  id="coupon_code" '); ?>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <?= form_input('coupon_descripion',$CouponInfo->coupon_descripion, 'placeholder="Coupon Descripion" class="form-control" required = "required"  id="coupon_descripion" '); ?>
                    ...
                    <div class="form-group row "  >
                        ...
                        <div class="col-sm-8">
                            <input type="text" min="1" value="<?= isset($_POST['max_coupons']) ? htmlspecialchars($_POST['max_coupons']) : htmlspecialchars($CouponInfo->max_coupons) ?>" maxlength="5" name='max_coupons' value="<?= (isset($_POST['max_coupons'])) ? $_POST['max_coupons'] : '' ?>" placeholder="Max Coupons"  autocomplete="off" class="form-control "  id="max_coupons" onkeypress="return event.charCode >= 48 && event.charCode <= 57" />
...
document.getElementById('discount_rate').addEventListener('input', function () {
    ...
    // Remove any minus signs entered
    if (value.includes('-')) {
