...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        echo form_open_multipart("system_settings/update_prices_csv/".$group->id, $attrib); ?>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="well well-small">
                        <a href="<?php echo base_url(); ?>assets/mdata/<?php echo $Customer_assets; ?>/csv/sample_product_price.csv" class="btn btn-primary pull-right">
