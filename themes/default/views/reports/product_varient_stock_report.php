...
$(document).ready(function () {
    ...
    var columns = [
        ...
        { "data": "color_name", "className": "text-left variant-left" },
        { "data": "brand_name", "className": "text-left variant-left" }
    ];

    if (show_batch) {
        columns.push({ "data": "batch_numbers", "className": "text-left variant-left" });
    }

    columns.push({ "data": "qty_product_cost", "mRender": formatQuantity });
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-barcode"></i><?= lang('Product_Variant_Stock_Report'); ?> <?php
		...
		<div  >
                ...
                ?>
                <div class="col-sm-2" style="position:absolute; right:222px;margin-right: 15px;">
                    ...
                    <table id="PrRData" class="table table-striped table-bordered table-condensed table-hover dfTable reports-table"
                        ...
                        <thead>
                            <tr>
                                ...
                                <?php if(!empty($varient_name)) {
                                    foreach($varient_name as $key_varient_name => $value_varient_name) {
                                        echo '<th>'.$value_varient_name['name'].'</th>';
                                    }
                                } ?>
                            </tr>
                            </thead>
