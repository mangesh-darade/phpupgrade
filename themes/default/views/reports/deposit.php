    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                <h2 class="printdata text-center" style="display:none"><?= $Settings->site_name ?></h2>
                    <h3 class="printdata text-center" style="display:none"> Deposit Report <?php
                        if ($this->input->post('start_date')) {
                            echo " (" . $this->input->post('start_date') . " to " . $this->input->post('end_date') . ")";
                        }
                        ?>
                    </h3>
                    <table id="SlRData"
