...
?>
<!-- Add this in your view file, after the table HTML but before your <script> tags -->
<style>
#PrRData th:nth-child(3),
#PrRData td:nth-child(3),
#PrRData th:nth-child(4),
#PrRData td:nth-child(4) {
    text-align: left !important;
}
#PrRData th:nth-child(n+6),
#PrRData td:nth-child(n+6) {
...
<script> 
    $(document).ready(function () {
        ...
        "ajax": {
			'type': 'POST',
            "url": '<?= site_url('reports/load_product_varient_sale_report/?v=1'. $v) ?>',
			//"dataSrc": "",
            'data': {
			   action: 'List',
			},
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-barcode"></i><?= lang('Products_Variant_Sale_Report'); ?> <?php
            if($this->input->post('start_date'))
            {
        ...
        <div class="row">
            <div class="col-lg-12">
                <div id="form">
                    ...
                    <?php echo form_open("reports/product_varient_sale_report"); ?>
                    <div class="row"> 
						 <div class="col-sm-2">
    ...
    $(document).ready(function () {
        ...
        $('#xls').click(function (event) {
            ...
            if(limitcnt=='0'){
              ...
              window.location.href = "<?=site_url('reports/load_product_varient_sale_report/xls/?v=export' . $v)?>"+limitcnt;
               $("#limitpdf").val(0).change();
              return false;
            }
        ...
        $('#image').click(function (event) {
            event.preventDefault();
			window.location.href = "<?=site_url('reports/load_product_varient_sale_report/img/?v=export' . $v)?>";
            /*html2canvas($('.box'), {
