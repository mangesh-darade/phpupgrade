...
<p class="introtext"><?= lang("reports_calendar_text") ?></p>
            ...
            <div class="box-header">
                ...
                <div class="box-icon">
                    <ul class="btn-tasks">
                        ...
                        <li class="dropdown"><a href="#" id="xls1" class="tip" title="<?= lang('download_xls') ?>"><i
                                    class="icon fa fa-file-excel-o"></i></a></li>
 ...
 null,{"mRender": currencyFormat}, {"mRender": currencyFormat},{"mRender": currencyFormat}, {"mRender": currencyFormat}, {"mRender": row_status}],
                    "fnFooterCallback": function (nRow, aaData, iStart, iEnd, aiDisplay) {
                        var gtotal = 0, paid = 0, balance = 0,discountTotal = 0;
                        for (var i = 0; i < aaData.length; i++) {
                            gtotal += parseFloat(aaData[aiDisplay[i]][7]);
                            discountTotal += parseFloat(aaData[aiDisplay[i]][8]);
                            paid += parseFloat(aaData[aiDisplay[i]][9]);
                            balance += parseFloat(aaData[aiDisplay[i]][10]);
                        }
                        var nCells = nRow.getElementsByTagName('th');
                        nCells[7].innerHTML = currencyFormat(parseFloat(gtotal));
                        nCells[8].innerHTML = currencyFormat(parseFloat(discountTotal)); 
                ...
                <div class="row">
                    <div class="col-lg-12">
		                ...
		                <div class="controls">
                            ...
                            <div class="form-group">
                                <div class="controls" style="margin-top:20px;"> <?= form_submit('submit_sale_report', lang("submit"), 'class="btn btn-primary"'); ?>
        ...
        <div class="box">
            <div class="box-header">
                <h2 class="blue"><i class="fa-fw fa fa-star nb"></i><?= lang('staff_purchases_report'); ?> <?php
                    if ($this->input->post('pr_start_date')) {
                        echo "From " . $this->input->post('pr_start_date') . " to " . $this->input->post('pr_end_date');
                    }
                    ?></h2>
                    ...
                    <div class="col-lg-12">
		                ...
		                <div class="controls">
		                    ...
		                    <div class="input-group">
		                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
		                        <input type="text"
		                               value="<?php echo isset($_POST['pr_start_date']) ? $_POST['pr_start_date'].'-'.$_POST['pr_start_date'] : "";?>"
		                               class="form-control daterange_search">
		                        <span class="input-group-addon" style="display:none;"><i class="fa fa-chevron-down"></i></span>
		                         <input type="hidden" name="pr_start_date"  id="start_date" class="start_date_n"  value="<?php echo isset($_POST['pr_start_date']) ? $_POST['pr_start_date'] : "";?>">
		                         <input type="hidden" name="pr_end_date"  id="end_date" class="end_date_n" value="<?php echo isset($_POST['pr_end_date']) ? $_POST['pr_end_date'] : "";?>" >
                                    </div>
		                </div>
		                </div>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="controls" style="margin-top:20px;"> <?= form_submit('submit_purchase_report', lang("submit"), 'class="btn btn-primary"'); ?>
                                 <a href="reports/restbutton" class="btn btn-success">Reset</a> 
                               </div>
                            </div>
                            <?= form_close(); ?>
        ...
        <script>
            $(document).ready(function () {
                ...
                var oTable = $('#PayRData').dataTable({
                    ...
                    "aoColumns": [null, null, null, null,null, null, {"mRender": paid_by}, {"mRender": currencyFormat}, {"mRender": row_status}],
                    'fnRowCallback': function (nRow, aData, iDisplayIndex) {
                        nRow.id = aData[9];
                    ...
                    {column_number: 3, filter_default_label: "[<?=lang('Invoice No');?>]", filter_type: "text", data: []},
                    {
                        column_number: 4,
                    ...
                    {column_number: 5, filter_default_label: "[<?=lang('Order Ref');?>]", filter_type: "text", data: []},
        ...
        <div class="box">
            <div class="box-header">
                <h2 class="blue"><i class="fa-fw fa fa-money nb"></i><?= lang('staff_payments_report'); ?> <?php
                    if ($this->input->post('pay_start_date')) {
                        echo "From " . $this->input->post('pay_start_date') . " to " . $this->input->post('pay_end_date');
                    }
                    ?></h2>
                    ...
                    <div class="col-lg-12">
		                ...
		                <div class="controls">
		                    ...
		                    <div class="input-group">
		                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
		                        <input type="text"
		                               value="<?php echo isset($_POST['pay_start_date']) ? $_POST['pay_start_date'].'-'.$_POST['pay_end_date'] : "";?>"
		                               class="form-control daterange_search">
		                        <span class="input-group-addon" style="display:none;"><i class="fa fa-chevron-down"></i></span>
		                         <input type="hidden" name="pay_start_date"  id="start_date" class="start_date_n"  value="<?php echo isset($_POST['pay_start_date']) ? $_POST['pay_start_date'] : "";?>">
		                         <input type="hidden" name="pay_end_date"  id="end_date" class="end_date_n" value="<?php echo isset($_POST['pay_end_date']) ? $_POST['pay_end_date'] : "";?>" >
                                    </div>
		                </div>
		                </div>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="controls" style="margin-top:20px;">
                                  <?= form_submit('submit_payment_report', lang("submit"), 'class="btn btn-primary"'); ?> 
                                  <a href="reports/restbutton" class="btn btn-success">Reset</a> 
                                </div>
                            </div>
                            <?= form_close(); ?>
                ...
                <div class="row">
                    <div class="col-lg-12">
		                ...
		                <div class="controls">
		                    ...
		                    <div class="input-group">
		                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
		                        <input type="text" value="<?php echo isset($_POST['login_start_date']) ? $_POST['login_start_date'].'-'.$_POST['login_start_date'] : "";?>"
		                               class="form-control daterange_search">
		                        <span class="input-group-addon" style="display:none;"><i class="fa fa-chevron-down"></i></span>
		                         <input type="hidden" name="login_start_date"  id="start_date" class="start_date_n"  value="<?php echo isset($_POST['login_start_date']) ? $_POST['login_start_date'] : "";?>">
		                         <input type="hidden" name="login_end_date"  id="end_date" class="end_date_n" value="<?php echo isset($_POST['login_end_date']) ? $_POST['login_end_date'] : "";?>" >
                                    </div>
		                </div>
		                </div>
                                </div>
                            ...
                            <div class="form-group">
                                <div  class="controls" style="margin-top:20px;"> 
                                  <?= form_submit('submit_login_report', lang("submit"), 'class="btn btn-primary"'); ?>
                                  <a href="reports/restbutton" class="btn btn-success">Reset</a> 
                                </div>
                            </div>
                            <?= form_close(); ?>
    ...
    $(document).ready(function () {
        $('#pdf').click(function (event) {
         ...
         $('#xls').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=site_url('reports/staff_report/'.$user_id.'/'.$year.'/'.$month.'/xls')?>";
            return false;
        });
        ...
        $('#pdf1').click(function (event) {
         ...
         $('#xls1').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=site_url('reports/staff_report/'.$user_id.'/'.$year.'/'.$month.'/xls/1')?>";
            return false;
        });
