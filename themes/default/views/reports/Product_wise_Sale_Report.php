                        ...
                        static $number = 0;
                         foreach ($products as $product) { 
                            ...
                            <tr>
                                    ...
                                    {
                                        ?>
                                         <td style="text-align: center;"><?php echo $this->sma->formatQuantity($cust_pro_qty_new[$number][0]->qty) ?></td>
                                        <?php
                                        $number++;
                                    }
                                    ?>
                                ...
                                <td style="text-align: center;"><?php echo $this->sma->formatQuantity($quantity[$row][0]->qty) ?></td>
