    ...
    $(document).ready(function () {
        var oTable = $('#SlRData').dataTable({
            ...
            "fnFooterCallback": function (nRow, aaData, iStart, iEnd, aiDisplay) {
                var gtotal = 0, paid = 0, balance = 0, discount = 0;
    ...
    $(document).ready(function () {
        $('#pdf').click(function (event) {
            ...
            if(limitcnt=='0'){
              ...
              <?php 
              $v .= "&strtlimit="?>
               window.location.href = "<?=site_url('reports/getSalesReport/pdf/?v=1'.$v)?>"+limitcnt;
        ...
        $('#xls').click(function (event) {
            ...
            if(limitcnt=='0'){
              ...
              <?php 
              $v .= "&strtlimit="?>
              window.location.href = "<?=site_url('reports/getSalesReport/0/xls/?v=1'.$v)?>"+limitcnt;
              $("#limitpdf").val(0).change(); 
              return false;
