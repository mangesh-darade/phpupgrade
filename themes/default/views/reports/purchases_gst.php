<style>
    ...
    thead th:nth-child(12) .yadcf-filter-wrapper input,
    thead th:nth-child(13) .yadcf-filter-wrapper input,
    thead th:nth-child(14) .yadcf-filter-wrapper input,
    thead th:nth-child(15) .yadcf-filter-wrapper input,
    thead th:nth-child(16) .yadcf-filter-wrapper input,
    thead th:nth-child(17) .yadcf-filter-wrapper input,
    thead th:nth-child(18) .yadcf-filter-wrapper input,
    thead th:nth-child(19) .yadcf-filter-wrapper input
    {
    text-align:right;
