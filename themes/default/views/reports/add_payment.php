<?php defined('BASEPATH') OR exit('No direct script access allowed');
 ...
 ?>
<?php if($formaction=='add_eshop_order_payment') $ModuleAct='orders'; else $ModuleAct='sales'; ?>
<div class="modal-dialog">
    <div class="modal-content">
        ...
        // echo form_open_multipart($ModuleAct."/".$formaction."/" . $inv->id, $attrib); ?>
         <?php echo form_open("reports/add_payment"); ?>
        <div class="modal-body">
            ...
            <div class="row">
                ...
                <input type="hidden" value="<?php echo $sales_id;?>" name="sale_id"/>
                <input type="hidden" value="<?php echo $total; ?>" name="total_due"/>
                <input type="hidden" value="<?php echo $invoice_amounts; ?>" name="invoice_amount"/>
                                ...
                                <div class="payment">
                                    <div class="form-group">
                                        ...
                                        <input name="amount-paid" type="text" id="amount_1"
                                               value="<?= $this->sma->formatDecimal(($total + $rounding -($inv->return_sale_total? abs($inv->return_sale_total) :0)) - $paid); ?>"
