...
<script>
    $(document).ready(function () {
        ...
        var oTable = $('#SalesGST').dataTable({
            ...
            'sAjaxSource': '<?= site_url('reports/getTaxHsnCodeReports/?v=1' . $v) ?>',
        ...
        //    "aoColumns": [null,null, {"mRender": currencyFormat, "bSearchable": false}, {"mRender": currencyFormat, "bSearchable": false}, {"mRender": currencyFormat, "bSearchable": false}, {"mRender": currencyFormat, "bSearchable": false}, {"mRender": currencyFormat, "bSearchable": false}, {"mRender": currencyFormat, "bSearchable": false}],
           "aoColumns": [
            {"bSearchable": true}, // HSN
            null, // GST
            {"bSearchable": false}, // Quantity
            null, // Unit
            {"mRender": currencyFormat, "bSearchable": false}, // Taxable
            ...
            {"mRender": currencyFormat, "bSearchable": false}  // Sales
            ],
...
//                return nRow;
            ...
            var tqty = 0, tbasicamt= 0, tsgst = 0, tcgst =0, tigst = 0, tgst = 0 , tsales = 0;
            for (var i = 0; i < aaData.length; i++) {
                ...
                tgst += parseFloat(aaData[aiDisplay[i]][8] || 0);
                tsales += parseFloat(aaData[aiDisplay[i]][9] || 0);
            }
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    ...
                    <?php echo form_open("reports/hsncode_reports","id='searchform'"); ?>
                    <div class="row">
                    ...
                    <div class="form-group">
                        <div class="controls">
                            ...
                            <a href="<?= site_url('reports/hsncode_reports') ?>" type="reset" id="report_reset"  class="btn btn-warning input-xs">Reset </a>
                        </div>
                    </div>
                    <?php echo form_close(); ?>
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#pdf').click(function (event) {
            ...
            window.location.href = "<?=site_url('reports/getTaxHsnCodeReports/pdf/?v=1' . $v)?>";
            return false;
        });
        $('#xls').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=site_url('reports/getTaxHsnCodeReports/0/xls/?v=1' . $v)?>";
            return false;
        });
        $('#image').click(function (event) {
             event.preventDefault();
            window.location.href = "<?=site_url('reports/getTaxHsnCodeReports/0/0/xls/?v=1' . $v)?>";
            return false;
        });
    });
</script>