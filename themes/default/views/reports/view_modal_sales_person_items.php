                     ...
                     <table id="SaleItemData" class="table table-bordered table-hover table-striped pos_sale_table">
                        ...
                        <tr>
                           <th><?= lang("Product_name"); ?></th>
                            ...
                            <th><?= lang("Quantity"); ?></th>
                            <th><?= lang("Unit_Price (Including tax)"); ?></th>
                       ...
                       <tbody>
							...
							<tr>
								...
								<td style="text-align: left;"><?= $ResValue["product_code"]; ?></td>
								<td style="text-align: center;"><?= $this->sma->formatQuantity($ResValue["tot_qty"]); ?></td>
								<td style="text-align: right;"><?= $this->sma->formatMoney($ResValue["tot_net_price"]); ?></td>	
							</tr>
								<?php } }else{ ?>
							<tr>
                        ...
                        <tr class="active">
                            <th></th>
                            <th></th>
                            <th style="text-align: center;"><?= $this->sma->formatQuantity($tot_qty); ?></th>
                            <th style="text-align: right;"><?= $this->sma->formatMoney($tot_net_price); ?></th>  						
                        </tr>
                        </tfoot>
                    </table>
                </div>
