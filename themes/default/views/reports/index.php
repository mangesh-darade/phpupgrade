    ...
    <div class="box">
        ...
        <div class="box-content">
            <div class="row">
                ...
                <div class="col-md-2 col-xs-4 padding1010">
                    <a class="bdarkGreen white quick-button" href="<?= site_url('reports/best_sellers') ?>">
                ...
                <div class="col-md-2 col-xs-4 padding1010">
                    <a class="blightOrange white quick-button" href="<?= site_url('reports/expiry_alerts') ?>">
                ...
                <div class="col-md-2 col-xs-4 padding1010">
                    <a class="bred white quick-button" href="<?= site_url('reports/monthly_sales') ?>">
                ...
                <div class="col-md-2 col-xs-4 padding1010">
                    <a class="blightOrange white quick-button" href="<?= site_url('reports/sales') ?>">
                ...
                <div class="col-md-2 col-xs-4 padding1010">
                    <a class="bblue white quick-button" href="<?= site_url('reports/payments') ?>">
                ...
                <div class="col-md-2 col-xs-4 padding1010">
                    <a class="bdarkGreen white quick-button" href="<?= site_url('reports/cash_transaction') ?>">
                        <i class="fa fa-money"></i>

                        <p><?= lang('cash_transaction_report') ?></p>
                    </a>
                </div>

                <div class="col-md-2 col-xs-4 padding1010">
                    <a class="bdarkGreen white quick-button" href="<?= site_url('reports/profit_loss') ?>">
                        <i class="fa fa-money"></i>
                ...
                <div class="col-md-2 col-xs-4 padding1010">
                    <a class="bred white quick-button" href="<?= site_url('reports/purchases') ?>">
                ...
                <div class="col-md-2 col-xs-4 padding1010">
                    <a class="blightOrange white quick-button" href="<?= site_url('reports/customers') ?>">
                ...
                <div class="col-md-2 col-xs-4 padding1010">
                    <a class="bblue white quick-button" href="<?= site_url('reports/suppliers') ?>">
                ...
                <div class="col-md-2 col-xs-4 padding1010">
                    <a class="bdarkGreen white quick-button" href="<?= site_url('reports/staff_report') ?>">
