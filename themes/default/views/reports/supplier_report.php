		                ...
		                <div class="controls">
                            ...
                            <div class="form-group">
                                <div class="controls" style="margin-top:15px;"> 
                                 <?php echo form_submit('submit_purchase_report', $this->lang->line("submit"), 'class="btn btn-primary"'); ?> 
                        ...
                        <div class="table-responsive">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th><?= lang("supplier"); ?></th>
                                    <th style="text-align: center;"><?= lang("product_qty"); ?></th>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div id="payform">
                        ...
                        <div class="form-group">
                           <div class="controls" style="margin-top:15px;"> 
                           <?php echo form_submit('submit_payment_report', $this->lang->line("submit"), 'class="btn btn-primary"'); ?>
                           <a href="reports/restbutton" class="btn btn-success">Reset</a>
                           </div>
                        </div>
                        <?php echo form_close(); ?>
