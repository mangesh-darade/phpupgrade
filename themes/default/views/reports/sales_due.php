...
<script>
    $(document).ready(function () {
        var oTable = $('#SlRData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('reports/getSalesReportDue/?v=1'. $v) ?>',
            ...
            "aoColumns": [{"bVisible":false,"bSearchable": false}, null, null, null, null,  null, {
               // "bSearchable": false,
                "mRender": pqFormat
            }, {"mRender": currencyFormat,"bSearchable": false}, {"mRender": currencyFormat}, {"mRender": currencyFormat,"bSearchable": false}, {"mRender": row_status}],
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-heart"></i><?= lang('Due Sales Report'); ?> <?php
            if ($this->input->post('start_date')) {
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    ...
                    <?php echo form_open("reports/sales_due"); ?>
                    <div class="row">
                        <div class="col-sm-4">
    ...
    $(document).ready(function () {
        $('#pdf').click(function (event) {
            ...
            if(limitcnt=='0'){
              ...
              <?php 
              $v .= "&strtlimit="?>
               window.location.href = "<?=site_url('reports/getSalesReportDue/pdf/?v=1'.$v)?>"+limitcnt;
        ...
        $('#xls').click(function (event) {
            ...
            if(limitcnt=='0'){
              ...
              <?php 
              $v .= "&strtlimit="?>
              window.location.href = "<?=site_url('reports/getSalesReportDue/0/xls/?v=1'.$v)?>"+limitcnt;
              $("#limitpdf").val(0).change(); 
              return false;
            ...
            // event.preventDefault();
            // window.location.href = "<?=site_url('reports/getSalesReportDue/0/xls/?v=1'.$v)?>";
            // return false;
        });

        $('#image').click(function (event) {
            event.preventDefault();
			  window.location.href = "<?=site_url('reports/getSalesReportDue/0/0/img/?v=1'.$v)?>";
			/*
            html2canvas($('.box'), {
