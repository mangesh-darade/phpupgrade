...
<style>
    .delete_Offline, .add_payment_Sale, .add_payment_Offline, .edit_Offline, .add_delivery_Sale, .add_delivery_Offline, .view_payments_Offline, .download_POS, .email_Eshop, .duplicate_Eshop, .SaleDetailModel{
        display:none;
    }
    .SaleDetailModel_POS{
        display:block;
...
//                                                }    
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <?php
                                //$ss[""] = lang('select') . ' ' . lang('sale_status');
