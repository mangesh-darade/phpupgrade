...
//print_r($rows);
$resOutput = $this->sma->posBillTableCSI($default_printer, $inv, $return_sale, $rows, $return_rows,'',1);
...
if ($modal) {
    ...
    <html>
        <style>
            /* FORCE center alignment for QTY column */
            #receipt-data table thead th:nth-child(2),
            #receipt-data table tbody td:nth-child(2) {
                ...
                <div id="receipt-data" style="font-size: <?php echo $font_size; ?>pt !important">
                    ...
                    if ($default_printer->sales_person && $inv->seller) { ?>
                        ...
                        <div class="pull-right">
                            <strong><?php echo lang("Sales Person"); ?> : <?php echo $inv->seller; ?></strong>
                        </div>
                    <?php } ?>
                    <div class="row">
                        <div class="col-sm-12">
                        <div class="pull-right" style="font-weight: bold;"><?php echo lang("date") . ": " . $inv->date; ?></div>
                            <div class="pull-left" style="font-weight: bold;"><?php echo lang("Invoice No.") . ": " . $inv->invoice_no; ?>
                                <?php if ($pos_settingss->display_token == 1) {
                     ...
                     <div class="row">
                        <div class="col-sm-12">
                            <div class="pull-left" style="font-weight: bold;"><?php echo lang("reference_no") . ": " . $inv->reference_no; ?></div>
                        ...
                        <div class="col-sm-12">   
                                ...
                                <table style="width: 100%">
                                    <tr>
                                        <td style="width: 50%; vertical-align: top;   ">
                                           ...
                                           <?php  if (!empty($shipping_details->billing_phone)) {
                            ...
                            <?php } elseif (!empty($show_receipt_addresses)) { ?>
                                ...
                                if (!empty($customer->phone)) {
                                    echo '<span style="font-weight:bold">, Ph:&nbsp;' . $customer->phone . '</span><br/>';
                                }
                            ...
                            <?php } else { ?>
                                ...
                                if (isset($default_printer->show_customer_info) && $default_printer->show_customer_info == 1) {
                                    ...
                                    if ($customer->city || $customer->postal_code || $customer->state) {
                                            echo "<br/>";
                                        }
                                    }
                                    ...
                                    if (!empty($customer->state)) {
                                        echo ((!empty($customer->city) || !empty($customer->postal_code)) ? ",  " : "") . $customer->state;
                                    }
                    ...
                    if ($Settings->invoice_view == 1) {
                        ...
                        $resTaxTbl = $this->sma->getTaxSalesReport($inv->id, $Settings);
