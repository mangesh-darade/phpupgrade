...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="row">
                ...
                <input type="hidden" value="<?php echo $payment->challan_id; ?>" name="challan_id"/>
            </div>
            ...
            <div id="payments">
                ...
                <div class="well well-sm well_1">
					...
					if($payment->paid_by == 'award_point')
					    echo '<option value="award_point"' . ($payment->paid_by && $payment->paid_by == 'award_point' ? ' selected="selected"' : '') . '>' . lang("Award_Point") . '</option>'; ?>
                                    </select>
                                </div>
                            </div>
 ...
 <div class="form-group gc" style="display: none;">
        ...
        <div class="modal-footer">
            <?php if($payment->paid_by != 'award_point') echo form_submit('edit_payment', lang('edit_payment'), 'class="btn btn-primary"'); ?>
        </div>
    </div>
    <?php echo form_close(); ?>
</div>
    ...
    $(document).ready(function () {
        ...
        $(document).on('change', '.paid_by', function () {
            ...
            if (p_val == 'cash') {
                ...
                $('.pcheque_1').show();
                $('#cheque_no_1').focus();
            } else if(p_val == 'NEFT' || p_val == 'PAYTM' || p_val == 'Googlepay' || p_val == 'complimentry' || p_val == 'swiggy'  || p_val == 'zomato'  || p_val == 'ubereats' || p_val == 'magicpin'){
                $('.pcc_1').hide();
                $('.pcash_1').hide();
                $('.pcheque_1').hide();
