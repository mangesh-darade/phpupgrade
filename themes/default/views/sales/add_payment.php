    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="row">
                ...
                <input type="hidden" value="<?php echo $inv->id; ?>" name="<?php echo ($formaction == 'add_challan_payment') ? 'challan_id' : 'sale_id'; ?>"/>
            </div>
                                ...
                                <div class="payment">
                                    <div class="form-group">
                                        ...
                                        <input name="amount-paid" type="text" id="amount_1"
                                               value="<?= $this->sma->formatDecimal(($inv->grand_total + $inv->rounding -($inv->return_sale_total? abs($inv->return_sale_total) :0)) - $inv->paid); ?>"
