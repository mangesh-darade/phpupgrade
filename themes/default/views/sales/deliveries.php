...
<script>
    $(document).ready(function () {
        var dss = <?= json_encode(array('packing' => lang('packing'), 'delivering' => lang('delivering'), 'delivered' => lang('delivered'), 'partial' => lang('Partial'),'overall' => lang('Overall'),'pending'=> lang('Pending'))); ?>;
        function ds(x) {
            if (x == 'delivered') {
        ...
        var oTable = $('#DOData').dataTable({
            ...
            "aoColumns": [{"bSortable": false,"mRender": checkbox}, {"mRender": fld}, null, null, null, null,null,null,null,null,null,null, {"mRender": ds}, {"mRender": ds}, {"bSortable": false,"mRender": attachment}, {"bSortable": false}]
            ...
            {column_number: 5, filter_default_label: "[<?=lang('Customer Phone');?>]", filter_type: "text", data: []},
            ...
            {column_number: 8, filter_default_label: "[<?=lang('state');?>]", filter_type: "text", data: []},
            {column_number: 9, filter_default_label: "[<?=lang('Pincode');?>]", filter_type: "text", data: []},
            {column_number: 10, filter_default_label: "[<?=lang('Delivery By');?>]", filter_type: "text", data: []},
            {column_number: 11, filter_default_label: "[<?=lang('Delivery Phone');?>]", filter_type: "text", data: []},
            ...
            <div class="col-lg-12">
                ...
                <table id="DOData" class="table table-bordered table-hover table-striped table-condensed">
                    ...
                    <tr>
                        ...
                        <th><?= lang("state"); ?></th>
                        <th><?= lang("Pincode"); ?></th>
                        <th><?= lang("Delivery By"); ?></th>    
                        <th><?= lang("Delivery Phone"); ?></th>
                        <th><?= lang("status"); ?></th>
                        <th><?= lang("type"); ?></th>
